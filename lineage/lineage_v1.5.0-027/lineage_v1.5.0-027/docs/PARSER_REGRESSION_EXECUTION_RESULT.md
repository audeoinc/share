...
| Golden cases | 47 PASS |
| Verified output columns | 124 |
| Performance regression contract | PASS |

## Performance samples

The release test executed the configured performance cases and stayed within the bundled regression contract. Observed median times were approximately 0.140–0.630 ms and observed p95 times were approximately 0.336–0.977 ms in this execution environment.
