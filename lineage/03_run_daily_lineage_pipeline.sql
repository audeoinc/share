...
-- suffix='_tky' yields ope_m_lineage_config_tky. Leave a segment empty to omit
-- it. The names are injected into every repository DML through the __T_*__
...
SET table_config =
  table_name_prefix || 'm_' || 'lineage_config' || table_name_suffix;
SET table_execution_account_config =
  table_name_prefix || 'm_' || 'lineage_execution_account_config'
    || table_name_suffix;
