...
-- names. To rename a single table, override its SET line below. The names are
...
SET table_config =
  table_name_prefix || 'lineage_config' || table_name_suffix;
SET table_execution_account_config =
  table_name_prefix || 'lineage_execution_account_config' || table_name_suffix;
SET table_definition_registry =
  table_name_prefix || 'lineage_definition_registry' || table_name_suffix;
SET table_direct_dependency =
  table_name_prefix || 'lineage_direct_dependency' || table_name_suffix;
SET table_impact =
  table_name_prefix || 'lineage_impact' || table_name_suffix;
SET table_diagnostic =
  table_name_prefix || 'lineage_diagnostic' || table_name_suffix;
SET table_job_registry =
  table_name_prefix || 'lineage_job_registry' || table_name_suffix;
