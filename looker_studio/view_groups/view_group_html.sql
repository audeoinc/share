...
const MAX_TABS=12,MAX_SQL_TABS=24,MAX_DESC_TABS=16,MAX_LABEL_TABS=8,OUTER_TABS=["note","\u30AB\u30E9\u30E0\u5B9A\u7FA9","\u53C2\u7167\u95A2\u4FC2","\u30ED\u30B8\u30C3\u30AF\u5DEE\u5206","SQL"],MAX_OUTER_TABS=8,NOTE_MARK="<!--VG_NOTE-->",CSS_GEN=7;function cssGuard(){return`<div class="vg-cssgen7" style="margin:0 0 10px;padding:8px 12px;border:1px solid #D4A72C;border-radius:6px;background:#FFF8C5;color:#7D4E00;font:12px/1.6 'Roboto','Segoe UI',system-ui,sans-serif">\u3053\u306E\u30AB\u30FC\u30C9\u306B\u306F\u65B0\u3057\u3044 CSS\uFF08\u4E16\u4EE3 7\uFF09\u304C\u8981\u308A\u307E\u3059\u3002template_style.html \u3092\u8CBC\u308A\u76F4\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u8CBC\u308A\u66FF\u3048\u308B\u307E\u3067\u3001\u30BF\u30D6\u304C\u6B63\u3057\u304F\u51FA\u307E\u305B\u3093\uFF08\u5207\u308A\u66FF\u308F\u3089\u306A\u3044\u30FB\u4E2D\u8EAB\u304C\u5168\u90E8\u540C\u6642\u306B\u51FA\u308B\u30FB\u9078\u629E\u4E2D\u304C\u5206\u304B\u3089\u306A\u3044\uFF09\u3002</div>`}function esc(s){return String(s==null?"":s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function hashId(s){let n=2166136261;for(let e=0;e<String(s).length;e++)n^=String(s).charCodeAt(e),n=Math.imul(n,16777619)>>>0;return n.toString(36)}const label=s=>s.suffixes.map((n,e)=>n||s.members[e]&&s.members[e].viewName||"(suffix \u306A\u3057)").join(", ");function badge(s,n,e){return`<span class="vg-badge" style="color:${n};background:${e}">${esc(s)}</span>`}function header(s,n,e,t,o){const i=e>1;return`<div class="vg-header"><span class="vg-title">${esc(s)}</span>`+badge(`${n} View`,"#57606A","#EAEEF2")+badge(`${e} \u30B0\u30EB\u30FC\u30D7`,i?"#9A6700":"#1A7F37",i?"#FFF8C5":"#DAFBE1")+(t?badge("suffix \u672A\u8A8D\u8B58","#9A6700","#FFF8C5"):"")+(o?badge("\u30E9\u30D9\u30EB\u4E0D\u4E00\u81F4","#9A6700","#FFF8C5"):"")+"</div>"}function notice(s){return`<div class="vg-notice">${esc(s)}</div>`}const KIND_TEXT={entity:"\u5B9F\u4F53\u540D",string:"\u5024\uFF08\u6587\u5B57\u5217\uFF09",number:"\u5024\uFF08\u6570\u5024\uFF09",ident:"\u540D\u524D",quoted:"\u540D\u524D",keyword:"\u4E88\u7D04\u8A9E",punct:"\u8A18\u53F7",comment:"\u30B3\u30E1\u30F3\u30C8"},kindText=s=>KIND_TEXT[s]||s;function wrapPage(s,n,e,t,o,i,l){const r=i||{},u="vgo"+hashId(r.base||""),a=[`<div class="vg-root">${o==null||o===""?NOTE_MARK:String(o)}</div>`,e,n,s,t],d=OUTER_TABS.map((m,v)=>`<input class="vg-or vg-or${v+1}" type="radio" name="${u}" id="${u}-${v+1}"${v===0?" checked":""}>`).join(""),p=OUTER_TABS.map((m,v)=>`<label class="vg-otab vg-ot${v+1}" for="${u}-${v+1}">${esc(m)}</label>`).join(""),h=OUTER_TABS.map((m,v)=>`<div class="vg-opanel vg-op${v+1}">${a[v]||""}</div>`).join(""),g=r.base?header(r.base,r.viewCount,(r.groups||[]).length,r.unmatched,l):"";return`<div class="vg-outer">${cssGuard()}${d}<div class="vg-otablist">${g}${p}</div><div class="vg-opanels">${h}</div></div>`}const WARN="\u26A0",MAX_TABLE_W=1e3,MIN_COL_W=150,NAME_COL_W=180;function breakType(s){return String(s).replace(/(&lt;|,)/g,"$1<wbr>")}const DESC_JA_KEYS=["ja","jp","ja_name","name_ja","japanese","logical_name_ja","logicalNameJa","ja_logical_name","\u548C\u540D","\u65E5\u672C\u8A9E","\u65E5\u672C\u8A9E\u8AD6\u7406\u540D","\u8AD6\u7406\u540D"],DESC_EN_KEYS=["en","en_name","name_en","english","logical_name_en","logicalNameEn","en_logical_name","\u82F1\u8A9E","\u82F1\u8A9E\u8AD6\u7406\u540D"];function pickKey(s,n){for(let e=0;e<n.length;e++){const t=n[e];if(!Object.prototype.hasOwnProperty.call(s,t))continue;const o=s[t];if(!(o==null||String(o)===""))return{key:t,value:String(o)}}return null}function parseDesc(s){const n=String(s==null?"":s).trim();if(!n)return null;if(n.charAt(0)!=="{")return{raw:n};let e=null;try{e=JSON.parse(n)}catch(c){e=null}if(!e||typeof e!="object"||Array.isArray(e))return{raw:n};const t=pickKey(e,DESC_JA_KEYS),o=pickKey(e,DESC_EN_KEYS),i={};t&&(i[t.key]=!0),o&&(i[o.key]=!0);const l=[],r=Object.keys(e);for(let c=0;c<r.length;c++){const a=r[c];if(i[a])continue;const d=e[a];d==null||d===""||l.push({key:a,value:typeof d=="object"?JSON.stringify(d):String(d)})}const u=[];t&&u.push(t),o&&u.push(o);for(let c=0;c<l.length;c++)u.push(l[c]);return{ja:t?t.value:"",en:o?o.value:"",rest:l,pairs:u}}function descHtml(s){const n=parseDesc(s);return n?n.raw?`<div class="vg-cdesc">${esc(n.raw)}</div>`:n.pairs.length?`<table class="vg-cdtable">${n.pairs.map(t=>`<tr><th class="vg-cdk">${esc(t.key)}</th><td class="vg-cdv">${esc(t.value)}</td></tr>`).join("")}</table>`:"":""}function structFields(s){const n=String(s==null?"":s),e=n.indexOf("STRUCT<");if(e<0)return[];const t=[];let o="",i=0;for(let r=e+7;r<n.length;r++){const u=n.charAt(r);if(u===">"&&i===0){t.push(o);break}if(u==="<")i++;else if(u===">")i--;else if(u===","&&i===0){t.push(o),o="";continue}o+=u}const l=[];for(let r=0;r<t.length;r++){const u=t[r].trim().split(/[\s<]/)[0];u&&l.push(u)}return l}function assignOrder(s){const n=e=>("000"+e).slice(-4);for(const e of s.values()){const t=e.name.split("."),o=s.get(t[0]),i=o&&o.vals[0]&&o.vals[0].ord!=null?o.vals[0].ord:9999;let l=n(i),r=t[0];for(let u=1;u<t.length;u++){const c=s.get(r),d=(c&&c.vals[0]?structFields(c.vals[0].type):[]).indexOf(t[u]);l+="."+n(d<0?9999:d),r+="."+t[u]}e.sortKey=l}}function typeShape(s){const n=String(s==null?"":s).trim(),e=n.slice(0,6).toUpperCase()==="ARRAY<";let t=n;e&&(t=n.slice(n.indexOf("<")+1,n.lastIndexOf(">")).trim());const o=t.slice(0,7).toUpperCase()==="STRUCT<";return{repeated:e,record:o,name:o?"RECORD":t}}const isNested=s=>String(s).indexOf(".")>=0;function columnSig(s){const n=(s||[]).map(e=>[String(e.n==null?"":e.n),String(e.t==null?"":e.t),e.u==null||e.u===""?"":String(e.u).toUpperCase(),String(e.d==null?"":e.d)].join("\u0001"));return n.sort(),n.join("\u0002")}function columnGroups(s,n){const e=new Map,t=[],o=s&&s.groups||[];for(let l=0;l<o.length;l++){const r=o[l],u=r.members||[];for(let c=0;c<u.length;c++){const a=u[c],d=columnSig(n[a.viewName]);let p=e.get(d);p||(p={suffixes:[],members:[]},e.set(d,p),t.push(p)),p.suffixes.push((r.suffixes&&r.suffixes[c])!=null?r.suffixes[c]:null),p.members.push(a)}}const i=l=>String(l.suffixes[0]==null?l.members[0].viewName:l.suffixes[0]);for(const l of t){const r=l.members.map((u,c)=>c).sort((u,c)=>{const a=String(l.suffixes[u]==null?l.members[u].viewName:l.suffixes[u]),d=String(l.suffixes[c]==null?l.members[c].viewName:l.suffixes[c]);return a<d?-1:a>d?1:0});l.suffixes=r.map(u=>l.suffixes[u]),l.members=r.map(u=>l.members[u])}return t.sort((l,r)=>r.members.length-l.members.length||(i(l)<i(r)?-1:i(l)>i(r)?1:0)),t}function descCell(s){return!s||!s.descs.length?"":s.descs.length===1?descHtml(s.descs[0].text):s.descs.map(n=>`<div class="vg-cdescwho">${esc(n.suffixes.join(", "))}</div>`+descHtml(n.text)).join("")}function groupColumns(s,n){const e=new Map,t=s.members||[];for(let o=0;o<t.length;o++){const i=t[o],l=s.suffixes&&s.suffixes[o]||i.viewName,r=n[i.viewName]||[];for(let u=0;u<r.length;u++){const c=r[u];let a=e.get(c.n);if(a||(a={name:c.n,descs:[],order:u,vals:[]},e.set(c.n,a)),c.d){const d=String(c.d);let p=null;for(let h=0;h<a.descs.length;h++)a.descs[h].text===d&&(p=a.descs[h]);p?p.suffixes.push(l):a.descs.push({text:d,suffixes:[l]})}a.vals.push({suffix:l,type:c.t,ord:c.o==null?u+1:c.o,nullable:c.u==null||c.u===""?null:String(c.u).toUpperCase()!=="NO"})}}return assignOrder(e),e}function columnOrder(s){const n=new Set,e=[];for(const t of s){const o=[...t.values()].sort((i,l)=>i.sortKey<l.sortKey?-1:i.sortKey>l.sortKey?1:0);for(const i of o)n.has(i.name)||(n.add(i.name),e.push(i.name))}return e}function majority(s){const n=new Map;for(const o of s)n.set(o,(n.get(o)||0)+1);let e=null,t=-1;for(const o of s){const i=n.get(o);i>t&&(e=o,t=i)}return e}const nullText=s=>s===null?"UNKNOWN":s?"NULLABLE":"REQUIRED";function uniq(s){const n=[];for(const e of s)n.indexOf(e)<0&&n.push(e);return n}function cellInfo(s,n){if(!s)return{text:null,meta:"",sig:null,mixed:!1};const e=uniq(s.vals.map(r=>r.type)),t=uniq(s.vals.map(r=>nullText(r.nullable))),o=uniq(s.vals.map(r=>String(r.ord))).length>1||s.vals.length!==n,i=s.vals.map(r=>typeShape(r.type)),l=s.descs.map(r=>r.text).join("\u0001");return{text:e.join(" / "),shape:uniq(i.map(r=>r.name)).join(" / "),repeated:i.length>0&&i.every(r=>r.repeated),record:i.some(r=>r.record),nulls:t.join(" / "),sig:e.join(" / ")+"|"+t.join(" / ")+"|"+l,mixed:o}}function mixedTip(s,n){const e=isNested(s.name),t=s.vals.map(i=>e?`${i.suffix} = ${i.type}`:`${i.suffix} = #${i.ord} ${i.type} ${nullText(i.nullable)}`),o=s.vals.map(i=>i.suffix);for(let i=0;i<(n.members||[]).length;i++){const l=n.suffixes&&n.suffixes[i]||n.members[i].viewName;o.indexOf(l)<0&&t.push(`${l} = (\u3053\u306E\u5217\u3092\u6301\u305F\u306A\u3044)`)}return t.join(`
`)}function renderColumns(s,n){if(!(s.groups||[]).length)return notice("View \u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002");const e=columnGroups(s,n||{}),t=e.map(g=>groupColumns(g,n||{})),o=columnOrder(t);if(!o.length)return notice("\u30AB\u30E9\u30E0\u5B9A\u7FA9\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002INFORMATION_SCHEMA.COLUMNS \u304B\u3089\u5217\u304C\u8AAD\u3081\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002");const i=new Set;for(const g of o){const m=g.lastIndexOf(".");m>0&&i.add(g.slice(0,m))}let l=0,r=0;const u=o.map(g=>{const m=g.split("."),v=m.length-1,S=v>0,$=e.map((f,j)=>cellInfo(t[j].get(g),f.members.length)),b=majority($.map(f=>f.sig));$.some(f=>f.sig!==b)&&l++;const x=$.map((f,j)=>{const O=e[j],N=t[j].get(g),y=["vg-ccell"];f.text?f.sig!==b&&y.push("vg-cdiff"):y.push("vg-cnone"),f.mixed&&(y.push("vg-cmix"),r++);const C=!f.record||i.has(g)?f.shape:f.text,E=S?f.repeated?"REPEATED":"":f.repeated?"REPEATED":f.nulls,T=f.text?breakType(esc(C))+(f.mixed?`<span class="vg-cwarn" data-tip="${esc(mixedTip(N,O))}">${WARN}</span>`:"")+(E?`<span class="vg-cmeta">${esc(E)}</span>`:"")+descCell(N):"\u2014";return`<td class="${y.join(" ")}">${T}</td>`}).join(""),w="vg-cname"+(v?` vg-cd${Math.min(v,3)}`:""),_=v?`<span class="vg-cnestmark">\u2514</span>${esc(m[m.length-1])}`:esc(g);return`<tr><th class="${w}">${_}</th>${x}</tr>`}).join(""),c=e.map(g=>`<th class="vg-chead">${esc(label(g))}<span class="vg-tabn">${g.members.length}</span></th>`).join(""),a=[];e.length===1?a.push(notice(`${s.viewCount||e[0].members.length} \u672C\u306E View \u3059\u3079\u3066\u3067\u30AB\u30E9\u30E0\u5B9A\u7FA9\uFF08\u5217\u540D\u30FB\u578B\u30FB\u30E2\u30FC\u30C9\u30FB\u8AAC\u660E\uFF09\u304C\u4E00\u81F4\u3057\u3066\u3044\u307E\u3059\u3002`)):(a.push(notice(`\u30AB\u30E9\u30E0\u5B9A\u7FA9\u304C ${e.length} \u7A2E\u985E\u3042\u308A\u307E\u3059\uFF08\u5217\u304C\u305D\u306E\u672C\u6570\uFF09\u3002\u5217\u306F\u30ED\u30B8\u30C3\u30AF \u30B0\u30EB\u30FC\u30D7\u3067\u306F\u306A\u304F\u30AB\u30E9\u30E0\u5B9A\u7FA9\u3067\u675F\u306D\u3066\u3044\u308B\u306E\u3067\u3001SQL \u304C\u540C\u4E00\u3067\u3082\u53C2\u7167\u5148\u30C6\u30FC\u30D6\u30EB\u306E\u578B\u3084 description \u304C\u9055\u3048\u3070\u5225\u306E\u5217\u306B\u306A\u308A\u307E\u3059\uFF08\u30ED\u30B8\u30C3\u30AF\u5DEE\u5206\u306E\u30BF\u30D6\u306B\u306F\u51FA\u3066\u3053\u306A\u3044\u5DEE\u3067\u3059\uFF09\u3002`)),l&&a.push(notice(`\u578B\u30FB\u30E2\u30FC\u30C9\u30FB\u8AAC\u660E\u306E\u3044\u305A\u308C\u304B\u304C\u63C3\u3063\u3066\u3044\u306A\u3044\u5217\u304C ${l} \u4EF6\u3042\u308A\u307E\u3059\uFF08\u8272\u4ED8\u304D\u306E\u30BB\u30EB\u3002\u305D\u306E\u5217\u3067\u3044\u3061\u3070\u3093\u591A\u3044\u5185\u5BB9\u3068\u9055\u3046\u3082\u306E\uFF09\u3002`))),r&&a.push(notice(`\u540C\u3058\u5217\u306E\u4E2D\u3067\u4E26\u3073\u9806\uFF08ordinal\uFF09\u3060\u3051\u304C\u98DF\u3044\u9055\u3063\u3066\u3044\u308B\u7B87\u6240\u304C${r} \u4EF6\u3042\u308A\u307E\u3059\uFF08${WARN} \u306E\u5370\u3002\u30DB\u30D0\u30FC\u3059\u308B\u3068 suffix \u3054\u3068\u306E\u5185\u8A33\u304C\u51FA\u307E\u3059\uFF09\u3002\u4E26\u3073\u9806\u306F\u5217\u306E\u675F\u306D\u65B9\u306B\u3082\u8868\u306E\u4E2D\u8EAB\u306B\u3082\u4F7F\u3063\u3066\u3044\u306A\u3044\u306E\u3067\u3001\u3053\u3053\u306B\u3060\u3051\u51FA\u307E\u3059\u3002`));const d=`<colgroup><col style="width:${NAME_COL_W}px">`+e.map(()=>"<col>").join("")+"</colgroup>",p=NAME_COL_W+MIN_COL_W*e.length,h=p>MAX_TABLE_W?` style="min-width:${p}px"`:"";return a.join("")+`<div class="vg-ctablewrap"><table class="vg-ctable"${h}>${d}<thead><tr><th class="vg-chead vg-cnamehead">\u5217\u540D</th>${c}</tr></thead><tbody>${u}</tbody></table></div>`}function renderColumnsBase(s,n){return`<div class="vg-root">${renderColumns(s,n)}</div>`}function sqlViews(s){const n=[],e=s.groups||[];for(let t=0;t<e.length;t++){const o=e[t],i=o.members||[];for(let l=0;l<i.length;l++)n.push({suffix:o.suffixes&&o.suffixes[l]||i[l].viewName||"(suffix \u306A\u3057)",viewName:i[l].viewName,group:label(o),groupSize:i.length})}return n.sort((t,o)=>String(t.suffix).localeCompare(String(o.suffix))),n}function sqlBody(s){const n=String(s).replace(/\r\n?/g,`
`).split(`
`);for(;n.length>1&&n[n.length-1].trim()==="";)n.pop();const e=String(n.length).length;return{html:`<div class="vg-sqlbox"><pre class="vg-sqlpre">${n.map((o,i)=>{const l=String(i+1);return`<span class="vg-sqln">${new Array(e-l.length+1).join(" ")}${l}</span> `+esc(o)}).join(`
`)}</pre></div>`,lines:n.length}}function sqlPanel(s,n){if(n==null||String(n)==="")return`<div class="vg-sqlhead"><span class="vg-sqlname">${esc(s.viewName)}</span></div>`+notice("\u3053\u306E View \u306E SQL \u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002");const e=sqlBody(n);return`<div class="vg-sqlhead"><span class="vg-sqlname">${esc(s.viewName)}</span><span class="vg-sqlmeta">\u30B0\u30EB\u30FC\u30D7: ${esc(s.group)}</span><span class="vg-sqlmeta">${e.lines} \u884C</span></div>`+e.html}function renderSql(s,n){const e=sqlViews(s);if(!e.length)return notice("View \u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002");const t=n||{};if(!e.some(a=>t[a.viewName]))return notice("SQL \u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002INFORMATION_SCHEMA.VIEWS \u304B\u3089 view_definition \u304C\u8AAD\u3081\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002");const o=e.slice(0,24),i="vgs"+hashId(s.base+"|"+e.map(a=>a.viewName).join("|")),l=o.map((a,d)=>`<input class="vg-sr vg-sr${d+1}" type="radio" name="${i}" id="${i}-${d+1}"${d===0?" checked":""}>`).join(""),r=o.map((a,d)=>`<label class="vg-stab vg-st${d+1}" for="${i}-${d+1}">${esc(a.suffix)}</label>`).join(""),u=o.map((a,d)=>`<div class="vg-spanel vg-sp${d+1}">${sqlPanel(a,t[a.viewName])}</div>`).join("");return(e.length>o.length?notice(`View \u304C\u591A\u3044\u305F\u3081\u5148\u982D 24 \u4EF6\u306E\u307F\u30BF\u30D6\u8868\u793A\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${e.length} \u4EF6\uFF09\u3002`):"")+`<div class="vg-stabs">${l}<div class="vg-stablist"><span class="vg-slabel">View</span>${r}</div><div class="vg-spanels">${u}</div></div>`}function renderSqlBase(s,n){return`<div class="vg-root">${renderSql(s,n)}</div>`}const DESC_TAB_ON="background:#EAEEF2;border-color:#8C959F;color:#24292F";function suffixByView(s){const n={},e=s&&s.groups||[];for(let t=0;t<e.length;t++){const o=e[t],i=o.members||[];for(let l=0;l<i.length;l++){const r=i[l]&&i[l].viewName;r&&(n[r]=o.suffixes&&o.suffixes[l]||r)}}return n}const cmp=(s,n)=>s<n?-1:s>n?1:0;function tabGroups(s,n,e){const t=suffixByView(s),o=Array.isArray(n)?n:[],i=[];for(let l=0;l<o.length;l++){const r=o[l]||{},u=Array.isArray(r.v)?r.v:r.v==null||r.v===""?[]:[r.v],c={label:u.map(a=>t[a]||a).sort(cmp).join(", ")||"(View \u306A\u3057)",count:u.length};e(c,r),i.push(c)}return i.sort((l,r)=>(l.empty===r.empty?0:l.empty?1:-1)||r.count-l.count||cmp(l.label,r.label)),i}function descGroups(s,n){return tabGroups(s,n,(e,t)=>{e.html=String(t.h==null?"":t.h),e.empty=e.html.trim()===""})}function labelGroups(s,n){return tabGroups(s,n,(e,t)=>{const o=Array.isArray(t.l)?t.l:[],i=[];for(let l=0;l<o.length;l++){const r=o[l]||{},u=String(r.k==null?"":r.k);u!==""&&i.push({k:u,v:String(r.v==null?"":r.v)})}i.sort((l,r)=>cmp(l.k,r.k)),e.pairs=i,e.empty=i.length===0})}function descPanel(s){return s.empty?notice("description \u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002"):s.html}const tabText=s=>`${esc(s.label)}<span class="vg-tabn">${s.count}</span>`;function renderDesc(s,n){const e=descGroups(s,n),t='<div class="vg-nhead">View \u306E description</div>';if(!e.length)return`<div class="vg-nsec">${t}`+notice("View \u306E description \u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002INFORMATION_SCHEMA.TABLE_OPTIONS \u304C\u8AAD\u3081\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002")+"</div>";if(e.length===1)return`<div class="vg-nsec">${t}<div class="vg-dtablist"><span class="vg-dtab vg-dstatic">${tabText(e[0])}</span></div><div class="vg-dbox">${descPanel(e[0])}</div></div>`;const o=e.slice(0,16),i="vgd"+hashId((s&&s.base||"")+"|"+e.map(a=>a.label).join("|")),l=o.map((a,d)=>`<input class="vg-dr vg-dr${d+1}" type="radio" name="${i}" id="${i}-${d+1}"${d===0?" checked":""}>`).join(""),r=o.map((a,d)=>`<label class="vg-dtab vg-dt${d+1}" for="${i}-${d+1}">${tabText(a)}</label>`).join(""),u=o.map((a,d)=>`<div class="vg-dpanel vg-dp${d+1}">${descPanel(a)}</div>`).join(""),c=e.length>o.length?notice(`description \u304C\u591A\u3044\u305F\u3081\u5148\u982D 16 \u7A2E\u985E\u306E\u307F\u51FA\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${e.length} \u7A2E\u985E\uFF09\u3002`):"";return`<div class="vg-nsec">${t}${c}<div class="vg-dtabs">${l}<div class="vg-dtablist">${r}</div><div class="vg-dpanels">${u}</div></div></div>`}function labelChips(s){return s.empty?notice("\u30E9\u30D9\u30EB\u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002"):'<div class="vg-lbchips">'+s.pairs.map(n=>`<span class="vg-lbchip"><span class="vg-lbk">${esc(n.k)}</span><span class="vg-lbv">${esc(n.v||"(\u7A7A)")}</span></span>`).join("")+"</div>"}function labelsSplit(s,n){return labelGroups(s,n).length>1}function renderLabels(s,n){const e=labelGroups(s,n);if(!e.length||e[0].empty)return"";if(e.length===1)return labelChips(e[0]);const t=e.slice(0,8),o="vgl"+hashId((s&&s.base||"")+"|"+e.map(c=>c.label+"="+c.pairs.map(a=>a.k+":"+a.v).join(",")).join("|")),i=t.map((c,a)=>`<input class="vg-lbr vg-lbr${a+1}" type="radio" name="${o}" id="${o}-${a+1}"${a===0?" checked":""}>`).join(""),l=t.map((c,a)=>`<label class="vg-lbtab vg-lbt${a+1}" for="${o}-${a+1}">${tabText(c)}</label>`).join(""),r=t.map((c,a)=>`<div class="vg-lbpanel vg-lbp${a+1}">${labelChips(c)}</div>`).join(""),u=e.length>t.length?notice(`\u30E9\u30D9\u30EB\u306E\u7A2E\u985E\u304C\u591A\u3044\u305F\u3081\u5148\u982D 8 \u7A2E\u985E\u306E\u307F\u51FA\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${e.length} \u7A2E\u985E\uFF09\u3002`):"";return'<div class="vg-nsec"><div class="vg-nhead">\u30E9\u30D9\u30EB</div>'+notice("\u540C\u3058 base \u306E\u4E2D\u3067\u30E9\u30D9\u30EB\u304C\u5272\u308C\u3066\u3044\u307E\u3059\u3002")+u+`<div class="vg-lbtabs">${i}<div class="vg-lbtablist">${l}</div><div class="vg-lbpanels">${r}</div></div></div>`}function renderNote(s,n,e,t){const o=String(e==null?"":e);return renderLabels(s,t)+renderDesc(s,n)+`<div class="vg-nsec"><div class="vg-nhead">\u30E1\u30E2</div>${o}</div>`}function __opts(s){if(!s)return{};try{return JSON.parse(s)||{}}catch(n){return{}}}function __notice(s){return'<div class="vg-notice">'+String(s).replace(/[<>&]/g,"")+"</div>"}function __run(s,n,e,t,o,i,l,r){var u=__opts(r),c;try{c=JSON.parse(s)}catch(_){c=null}if(!c)return String(n||__notice("\u89E3\u6790\u7D50\u679C\u3092\u8AAD\u307F\u53D6\u308C\u307E\u305B\u3093\u3067\u3057\u305F\u3002"));var a={};try{for(var d=JSON.parse(t)||[],p=0;p<d.length;p++)a[d[p].v]=d[p].cols||[]}catch(_){a={}}var h={};try{for(var g=JSON.parse(o)||[],m=0;m<g.length;m++)h[g[m].v]=g[m].s}catch(_){h={}}var v=[];try{v=JSON.parse(i)||[]}catch(_){v=[]}var S=[];try{S=JSON.parse(l)||[]}catch(_){S=[]}for(var $="",b="",A=c.bases||[],x=0;x<A.length;x++)$+=renderColumnsBase(A[x],a),b+=renderSqlBase(A[x],h);$||($=__notice("\u30AB\u30E9\u30E0\u5B9A\u7FA9\u3092\u51FA\u305B\u308B View \u304C\u3042\u308A\u307E\u305B\u3093\u3002")),b||(b=__notice("SQL \u3092\u51FA\u305B\u308B View \u304C\u3042\u308A\u307E\u305B\u3093\u3002"));var w=c.bases&&c.bases.length?c.bases[0]:null;return wrapPage(String(n||""),String(e||__notice("\u53C2\u7167\u95A2\u4FC2\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002")),$,b,renderNote(w,v,NOTE_MARK,S),w,labelsSplit(w,S))}return __run(analysis_json,diff_html,erd_html,columns_json,sql_json,descs_json,labels_json,options_json);
