...
var F=Object.defineProperty,R=Object.defineProperties;var q=Object.getOwnPropertyDescriptors;var O=Object.getOwnPropertySymbols;var V=Object.prototype.hasOwnProperty,D=Object.prototype.propertyIsEnumerable;var C=(s,e,n)=>e in s?F(s,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):s[e]=n,T=(s,e)=>{for(var n in e||(e={}))V.call(e,n)&&C(s,n,e[n]);if(O)for(var n of O(e))D.call(e,n)&&C(s,n,e[n]);return s},k=(s,e)=>R(s,q(e));const MAX_TABS=12,MAX_SQL_TABS=128,MAX_DESC_TABS=16,MAX_LABEL_TABS=8,OUTER_TABS=["note","\u30AB\u30E9\u30E0\u5B9A\u7FA9","\u53C2\u7167\u95A2\u4FC2","\u30ED\u30B8\u30C3\u30AF\u5DEE\u5206","SQL"],MAX_OUTER_TABS=8,NOTE_MARK="<!--VG_NOTE-->",CSS_GEN=9;function cssGuard(){return`<div class="vg-cssgen9" style="margin:0 0 10px;padding:8px 12px;border:1px solid #D4A72C;border-radius:6px;background:#FFF8C5;color:#7D4E00;font:12px/1.6 'Roboto','Segoe UI',system-ui,sans-serif">\u3053\u306E\u30AB\u30FC\u30C9\u306B\u306F\u65B0\u3057\u3044 CSS\uFF08\u4E16\u4EE3 9\uFF09\u304C\u8981\u308A\u307E\u3059\u3002template_style.html \u3092\u8CBC\u308A\u76F4\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u8CBC\u308A\u66FF\u3048\u308B\u307E\u3067\u3001\u30BF\u30D6\u304C\u6B63\u3057\u304F\u51FA\u307E\u305B\u3093\uFF08\u5207\u308A\u66FF\u308F\u3089\u306A\u3044\u30FB\u4E2D\u8EAB\u304C\u5168\u90E8\u540C\u6642\u306B\u51FA\u308B\u30FB\u9078\u629E\u4E2D\u304C\u5206\u304B\u3089\u306A\u3044\uFF09\u3002</div>`}function groupRule(s,e,n){const t=[];for(let o=1;o<=s;o++){const l=e(o);if(Array.isArray(l))for(const r of l)t.push(r);else t.push(l)}return t.join(",")+"{"+n+"}"}function esc(s){return String(s==null?"":s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function hashId(s){let e=2166136261;for(let n=0;n<String(s).length;n++)e^=String(s).charCodeAt(n),e=Math.imul(e,16777619)>>>0;return e.toString(36)}const label=s=>s.suffixes.map((e,n)=>e||s.members[n]&&s.members[n].viewName||"(suffix \u306A\u3057)").join(", ");function badge(s,e,n){return`<span class="vg-badge" style="color:${e};background:${n}">${esc(s)}</span>`}function header(s,e,n,t,o){const l=n>1;return`<div class="vg-header"><span class="vg-title">${esc(s)}</span>`+badge(`${e} View`,"#57606A","#EAEEF2")+badge(`${n} \u30B0\u30EB\u30FC\u30D7`,l?"#9A6700":"#1A7F37",l?"#FFF8C5":"#DAFBE1")+(t?badge("suffix \u672A\u8A8D\u8B58","#9A6700","#FFF8C5"):"")+(o?badge("\u30E9\u30D9\u30EB\u4E0D\u4E00\u81F4","#9A6700","#FFF8C5"):"")+"</div>"}function notice(s){return`<div class="vg-notice">${esc(s)}</div>`}const KIND_TEXT={entity:"\u5B9F\u4F53\u540D",string:"\u5024\uFF08\u6587\u5B57\u5217\uFF09",number:"\u5024\uFF08\u6570\u5024\uFF09",ident:"\u540D\u524D",quoted:"\u540D\u524D",keyword:"\u4E88\u7D04\u8A9E",punct:"\u8A18\u53F7",comment:"\u30B3\u30E1\u30F3\u30C8"},kindText=s=>KIND_TEXT[s]||s;function wrapPage(s,e,n,t,o,l,r){const a=l||{},i="vgo"+hashId(a.base||""),u=[`<div class="vg-root">${o==null||o===""?NOTE_MARK:String(o)}</div>`,n,e,s,t],p=OUTER_TABS.map((m,v)=>`<input class="vg-or vg-or${v+1}" type="radio" name="${i}" id="${i}-${v+1}"${v===0?" checked":""}>`).join(""),g=OUTER_TABS.map((m,v)=>`<label class="vg-otab vg-ot${v+1}" for="${i}-${v+1}">${esc(m)}</label>`).join(""),h=OUTER_TABS.map((m,v)=>`<div class="vg-opanel vg-op${v+1}">${u[v]||""}</div>`).join(""),f=a.base?header(a.base,a.viewCount,(a.groups||[]).length,a.unmatched,r):"";return`<div class="vg-outer">${cssGuard()}${p}<div class="vg-otablist">${f}${g}</div><div class="vg-opanels">${h}</div></div>`}const WARN="\u26A0",MAX_TABLE_W=1e3,MIN_COL_W=150,NAME_COL_W=180;function breakType(s){return String(s).replace(/(&lt;|,)/g,"$1<wbr>")}const DESC_JA_KEYS=["ja","jp","ja_name","name_ja","japanese","logical_name_ja","logicalNameJa","ja_logical_name","\u548C\u540D","\u65E5\u672C\u8A9E","\u65E5\u672C\u8A9E\u8AD6\u7406\u540D","\u8AD6\u7406\u540D"],DESC_EN_KEYS=["en","en_name","name_en","english","logical_name_en","logicalNameEn","en_logical_name","\u82F1\u8A9E","\u82F1\u8A9E\u8AD6\u7406\u540D"];function pickKey(s,e){for(let n=0;n<e.length;n++){const t=e[n];if(!Object.prototype.hasOwnProperty.call(s,t))continue;const o=s[t];if(!(o==null||String(o)===""))return{key:t,value:String(o)}}return null}function parseDesc(s){const e=String(s==null?"":s).trim();if(!e)return null;if(e.charAt(0)!=="{")return{raw:e};let n=null;try{n=JSON.parse(e)}catch(c){n=null}if(!n||typeof n!="object"||Array.isArray(n))return{raw:e};const t=pickKey(n,DESC_JA_KEYS),o=pickKey(n,DESC_EN_KEYS),l={};t&&(l[t.key]=!0),o&&(l[o.key]=!0);const r=[],a=Object.keys(n);for(let c=0;c<a.length;c++){const u=a[c];if(l[u])continue;const p=n[u];p==null||p===""||r.push({key:u,value:typeof p=="object"?JSON.stringify(p):String(p)})}const i=[];t&&i.push(t),o&&i.push(o);for(let c=0;c<r.length;c++)i.push(r[c]);return{ja:t?t.value:"",en:o?o.value:"",rest:r,pairs:i}}function descHtml(s){const e=parseDesc(s);return e?e.raw?`<div class="vg-cdesc">${esc(e.raw)}</div>`:e.pairs.length?`<table class="vg-cdtable">${e.pairs.map(t=>`<tr><th class="vg-cdk">${esc(t.key)}</th><td class="vg-cdv">${esc(t.value)}</td></tr>`).join("")}</table>`:"":""}function structFields(s){const e=String(s==null?"":s),n=e.indexOf("STRUCT<");if(n<0)return[];const t=[];let o="",l=0;for(let a=n+7;a<e.length;a++){const i=e.charAt(a);if(i===">"&&l===0){t.push(o);break}if(i==="<")l++;else if(i===">")l--;else if(i===","&&l===0){t.push(o),o="";continue}o+=i}const r=[];for(let a=0;a<t.length;a++){const i=t[a].trim().split(/[\s<]/)[0];i&&r.push(i)}return r}function assignOrder(s){const e=n=>("000"+n).slice(-4);for(const n of s.values()){const t=n.name.split("."),o=s.get(t[0]),l=o&&o.vals[0]&&o.vals[0].ord!=null?o.vals[0].ord:9999;let r=e(l),a=t[0];for(let i=1;i<t.length;i++){const c=s.get(a),p=(c&&c.vals[0]?structFields(c.vals[0].type):[]).indexOf(t[i]);r+="."+e(p<0?9999:p),a+="."+t[i]}n.sortKey=r}}function typeShape(s){const e=String(s==null?"":s).trim(),n=e.slice(0,6).toUpperCase()==="ARRAY<";let t=e;n&&(t=e.slice(e.indexOf("<")+1,e.lastIndexOf(">")).trim());const o=t.slice(0,7).toUpperCase()==="STRUCT<";return{repeated:n,record:o,name:o?"RECORD":t}}const isNested=s=>String(s).indexOf(".")>=0;function columnSig(s){const e=(s||[]).map(n=>[String(n.n==null?"":n.n),String(n.t==null?"":n.t),n.u==null||n.u===""?"":String(n.u).toUpperCase(),String(n.d==null?"":n.d)].join("\u0001"));return e.sort(),e.join("\u0002")}function columnGroups(s,e){const n=new Map,t=[],o=s&&s.groups||[];for(let r=0;r<o.length;r++){const a=o[r],i=a.members||[];for(let c=0;c<i.length;c++){const u=i[c],p=columnSig(e[u.viewName]);let g=n.get(p);g||(g={suffixes:[],members:[]},n.set(p,g),t.push(g)),g.suffixes.push((a.suffixes&&a.suffixes[c])!=null?a.suffixes[c]:null),g.members.push(u)}}const l=r=>String(r.suffixes[0]==null?r.members[0].viewName:r.suffixes[0]);for(const r of t){const a=r.members.map((i,c)=>c).sort((i,c)=>{const u=String(r.suffixes[i]==null?r.members[i].viewName:r.suffixes[i]),p=String(r.suffixes[c]==null?r.members[c].viewName:r.suffixes[c]);return u<p?-1:u>p?1:0});r.suffixes=a.map(i=>r.suffixes[i]),r.members=a.map(i=>r.members[i])}return t.sort((r,a)=>a.members.length-r.members.length||(l(r)<l(a)?-1:l(r)>l(a)?1:0)),t}function descCell(s){return!s||!s.descs.length?"":s.descs.length===1?descHtml(s.descs[0].text):s.descs.map(e=>`<div class="vg-cdescwho">${esc(e.suffixes.join(", "))}</div>`+descHtml(e.text)).join("")}function groupColumns(s,e){const n=new Map,t=s.members||[];for(let o=0;o<t.length;o++){const l=t[o],r=s.suffixes&&s.suffixes[o]||l.viewName,a=e[l.viewName]||[];for(let i=0;i<a.length;i++){const c=a[i];let u=n.get(c.n);if(u||(u={name:c.n,descs:[],order:i,vals:[]},n.set(c.n,u)),c.d){const p=String(c.d);let g=null;for(let h=0;h<u.descs.length;h++)u.descs[h].text===p&&(g=u.descs[h]);g?g.suffixes.push(r):u.descs.push({text:p,suffixes:[r]})}u.vals.push({suffix:r,type:c.t,ord:c.o==null?i+1:c.o,nullable:c.u==null||c.u===""?null:String(c.u).toUpperCase()!=="NO"})}}return assignOrder(n),n}function columnOrder(s){const e=new Set,n=[];for(const t of s){const o=[...t.values()].sort((l,r)=>l.sortKey<r.sortKey?-1:l.sortKey>r.sortKey?1:0);for(const l of o)e.has(l.name)||(e.add(l.name),n.push(l.name))}return n}function majority(s){const e=new Map;for(const o of s)e.set(o,(e.get(o)||0)+1);let n=null,t=-1;for(const o of s){const l=e.get(o);l>t&&(n=o,t=l)}return n}const nullText=s=>s===null?"UNKNOWN":s?"NULLABLE":"REQUIRED";function uniq(s){const e=[];for(const n of s)e.indexOf(n)<0&&e.push(n);return e}function cellInfo(s,e){if(!s)return{text:null,meta:"",sig:null,mixed:!1};const n=uniq(s.vals.map(a=>a.type)),t=uniq(s.vals.map(a=>nullText(a.nullable))),o=uniq(s.vals.map(a=>String(a.ord))).length>1||s.vals.length!==e,l=s.vals.map(a=>typeShape(a.type)),r=s.descs.map(a=>a.text).join("\u0001");return{text:n.join(" / "),shape:uniq(l.map(a=>a.name)).join(" / "),repeated:l.length>0&&l.every(a=>a.repeated),record:l.some(a=>a.record),nulls:t.join(" / "),sig:n.join(" / ")+"|"+t.join(" / ")+"|"+r,mixed:o}}function mixedTip(s,e){const n=isNested(s.name),t=s.vals.map(l=>n?`${l.suffix} = ${l.type}`:`${l.suffix} = #${l.ord} ${l.type} ${nullText(l.nullable)}`),o=s.vals.map(l=>l.suffix);for(let l=0;l<(e.members||[]).length;l++){const r=e.suffixes&&e.suffixes[l]||e.members[l].viewName;o.indexOf(r)<0&&t.push(`${r} = (\u3053\u306E\u5217\u3092\u6301\u305F\u306A\u3044)`)}return t.join(`
`)}function renderColumns(s,e){if(!(s.groups||[]).length)return notice("View \u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002");const n=columnGroups(s,e||{}),t=n.map(f=>groupColumns(f,e||{})),o=columnOrder(t);if(!o.length)return notice("\u30AB\u30E9\u30E0\u5B9A\u7FA9\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002INFORMATION_SCHEMA.COLUMNS \u304B\u3089\u5217\u304C\u8AAD\u3081\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002");const l=new Set;for(const f of o){const m=f.lastIndexOf(".");m>0&&l.add(f.slice(0,m))}let r=0,a=0;const i=o.map(f=>{const m=f.split("."),v=m.length-1,w=v>0,b=n.map((d,$)=>cellInfo(t[$].get(f),d.members.length)),S=majority(b.map(d=>d.sig));b.some(d=>d.sig!==S)&&r++;const x=b.map((d,$)=>{const M=n[$],N=t[$].get(f),y=["vg-ccell"];d.text?d.sig!==S&&y.push("vg-cdiff"):y.push("vg-cnone"),d.mixed&&(y.push("vg-cmix"),a++);const B=!d.record||l.has(f)?d.shape:d.text,E=w?d.repeated?"REPEATED":"":d.repeated?"REPEATED":d.nulls,L=d.text?breakType(esc(B))+(d.mixed?`<span class="vg-cwarn" data-tip="${esc(mixedTip(N,M))}">${WARN}</span>`:"")+(E?`<span class="vg-cmeta">${esc(E)}</span>`:"")+descCell(N):"\u2014";return`<td class="${y.join(" ")}">${L}</td>`}).join(""),j="vg-cname"+(v?` vg-cd${Math.min(v,3)}`:""),_=v?`<span class="vg-cnestmark">\u2514</span>${esc(m[m.length-1])}`:esc(f);return`<tr><th class="${j}">${_}</th>${x}</tr>`}).join(""),c=n.map(f=>`<th class="vg-chead">${esc(label(f))}<span class="vg-tabn">${f.members.length}</span></th>`).join(""),u=[];n.length===1?u.push(notice(`${s.viewCount||n[0].members.length} \u672C\u306E View \u3059\u3079\u3066\u3067\u30AB\u30E9\u30E0\u5B9A\u7FA9\uFF08\u5217\u540D\u30FB\u578B\u30FB\u30E2\u30FC\u30C9\u30FB\u8AAC\u660E\uFF09\u304C\u4E00\u81F4\u3057\u3066\u3044\u307E\u3059\u3002`)):(u.push(notice(`\u30AB\u30E9\u30E0\u5B9A\u7FA9\u304C ${n.length} \u7A2E\u985E\u3042\u308A\u307E\u3059\uFF08\u5217\u304C\u305D\u306E\u672C\u6570\uFF09\u3002\u5217\u306F\u30ED\u30B8\u30C3\u30AF \u30B0\u30EB\u30FC\u30D7\u3067\u306F\u306A\u304F\u30AB\u30E9\u30E0\u5B9A\u7FA9\u3067\u675F\u306D\u3066\u3044\u308B\u306E\u3067\u3001SQL \u304C\u540C\u4E00\u3067\u3082\u53C2\u7167\u5148\u30C6\u30FC\u30D6\u30EB\u306E\u578B\u3084 description \u304C\u9055\u3048\u3070\u5225\u306E\u5217\u306B\u306A\u308A\u307E\u3059\uFF08\u30ED\u30B8\u30C3\u30AF\u5DEE\u5206\u306E\u30BF\u30D6\u306B\u306F\u51FA\u3066\u3053\u306A\u3044\u5DEE\u3067\u3059\uFF09\u3002`)),r&&u.push(notice(`\u578B\u30FB\u30E2\u30FC\u30C9\u30FB\u8AAC\u660E\u306E\u3044\u305A\u308C\u304B\u304C\u63C3\u3063\u3066\u3044\u306A\u3044\u5217\u304C ${r} \u4EF6\u3042\u308A\u307E\u3059\uFF08\u8272\u4ED8\u304D\u306E\u30BB\u30EB\u3002\u305D\u306E\u5217\u3067\u3044\u3061\u3070\u3093\u591A\u3044\u5185\u5BB9\u3068\u9055\u3046\u3082\u306E\uFF09\u3002`))),a&&u.push(notice(`\u540C\u3058\u5217\u306E\u4E2D\u3067\u4E26\u3073\u9806\uFF08ordinal\uFF09\u3060\u3051\u304C\u98DF\u3044\u9055\u3063\u3066\u3044\u308B\u7B87\u6240\u304C${a} \u4EF6\u3042\u308A\u307E\u3059\uFF08${WARN} \u306E\u5370\u3002\u30DB\u30D0\u30FC\u3059\u308B\u3068 suffix \u3054\u3068\u306E\u5185\u8A33\u304C\u51FA\u307E\u3059\uFF09\u3002\u4E26\u3073\u9806\u306F\u5217\u306E\u675F\u306D\u65B9\u306B\u3082\u8868\u306E\u4E2D\u8EAB\u306B\u3082\u4F7F\u3063\u3066\u3044\u306A\u3044\u306E\u3067\u3001\u3053\u3053\u306B\u3060\u3051\u51FA\u307E\u3059\u3002`));const p=`<colgroup><col style="width:${NAME_COL_W}px">`+n.map(()=>"<col>").join("")+"</colgroup>",g=NAME_COL_W+MIN_COL_W*n.length,h=g>MAX_TABLE_W?` style="min-width:${g}px"`:"";return u.join("")+`<div class="vg-ctablewrap"><table class="vg-ctable"${h}>${p}<thead><tr><th class="vg-chead vg-cnamehead">\u5217\u540D</th>${c}</tr></thead><tbody>${i}</tbody></table></div>`}function renderColumnsBase(s,e){return`<div class="vg-root">${renderColumns(s,e)}</div>`}function sqlViews(s){const e=[],n=s.groups||[];for(let t=0;t<n.length;t++){const o=n[t],l=o.members||[];for(let r=0;r<l.length;r++)e.push({suffix:o.suffixes&&o.suffixes[r]||l[r].viewName||"(suffix \u306A\u3057)",viewName:l[r].viewName,group:label(o),groupSize:l.length})}return e.sort((t,o)=>{const l=String(t.suffix),r=String(o.suffix);return l.length-r.length||l.localeCompare(r)}),e}function sqlBody(s){const e=String(s).replace(/\r\n?/g,`
`).split(`
`);for(;e.length>1&&e[e.length-1].trim()==="";)e.pop();const n=String(e.length).length;return{html:`<div class="vg-sqlbox"><pre class="vg-sqlpre">${e.map((o,l)=>{const r=String(l+1);return`<span class="vg-sqln">${new Array(n-r.length+1).join(" ")}${r}</span> `+esc(o)}).join(`
`)}</pre></div>`,lines:e.length}}function sqlPanel(s,e){if(e==null||String(e)==="")return`<div class="vg-sqlhead"><span class="vg-sqlname">${esc(s.viewName)}</span></div>`+notice("\u3053\u306E View \u306E SQL \u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002");const n=sqlBody(e);return`<div class="vg-sqlhead"><span class="vg-sqlname">${esc(s.viewName)}</span><span class="vg-sqlmeta">\u30B0\u30EB\u30FC\u30D7: ${esc(s.group)}</span><span class="vg-sqlmeta">${n.lines} \u884C</span></div>`+n.html}function renderSql(s,e){const n=sqlViews(s);if(!n.length)return notice("View \u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002");const t=e||{};if(!n.some(u=>t[u.viewName]))return notice("SQL \u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002INFORMATION_SCHEMA.VIEWS \u304B\u3089 view_definition \u304C\u8AAD\u3081\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002");const o=n.slice(0,128),l="vgs"+hashId(s.base+"|"+n.map(u=>u.viewName).join("|")),r=o.map((u,p)=>`<input class="vg-sr vg-sr${p+1}" type="radio" name="${l}" id="${l}-${p+1}"${p===0?" checked":""}>`).join(""),a=o.map((u,p)=>`<label class="vg-stab vg-st${p+1}" for="${l}-${p+1}">${esc(u.suffix)}</label>`).join(""),i=o.map((u,p)=>`<div class="vg-spanel vg-sp${p+1}">${sqlPanel(u,t[u.viewName])}</div>`).join("");return(n.length>o.length?notice(`View \u304C\u591A\u3044\u305F\u3081\u5148\u982D 128 \u4EF6\u306E\u307F\u30BF\u30D6\u8868\u793A\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${n.length} \u4EF6\uFF09\u3002`):"")+`<div class="vg-stabs">${r}<div class="vg-stablist"><span class="vg-slabel">View</span>${a}</div><div class="vg-spanels">${i}</div></div>`}function renderSqlBase(s,e){return`<div class="vg-root">${renderSql(s,e)}</div>`}const DESC_TAB_ON="background:#EAEEF2;border-color:#8C959F;color:#24292F";function suffixByView(s){const e={},n=s&&s.groups||[];for(let t=0;t<n.length;t++){const o=n[t],l=o.members||[];for(let r=0;r<l.length;r++){const a=l[r]&&l[r].viewName;a&&(e[a]=o.suffixes&&o.suffixes[r]||a)}}return e}const cmp=(s,e)=>s<e?-1:s>e?1:0;function regionByView(s){const e={},n=Array.isArray(s)?s:[];for(let t=0;t<n.length;t++){const o=n[t]||{},l=Array.isArray(o.v)?o.v:[];for(let r=0;r<l.length;r++)e[l[r]]=String(o.r==null?"":o.r)}return e}function groupLabel(s,e,n){const t=i=>e[i]||i,o=new Map;for(let i=0;i<s.length;i++){const c=n[s[i]]||"";o.has(c)||o.set(c,[]),o.get(c).push(t(s[i]))}const l=s.map(t).sort(cmp).join(", ")||"(View \u306A\u3057)";if(o.size<=1)return{label:l,labelHtml:esc(l)};const r=[...o.keys()].sort(cmp),a=i=>o.get(i).slice().sort(cmp).join(", ");return{label:r.map(i=>(i||"(\u4E0D\u660E)")+": "+a(i)).join(" / "),labelHtml:r.map(i=>`<span class="vg-nreg"><span class="vg-nregname">${esc(i||"(\u4E0D\u660E)")}</span>${esc(a(i))}</span>`).join("")}}function tabGroups(s,e,n,t){const o=suffixByView(s),l=regionByView(t),r=Array.isArray(e)?e:[],a=[];for(let i=0;i<r.length;i++){const c=r[i]||{},u=Array.isArray(c.v)?c.v:c.v==null||c.v===""?[]:[c.v],p=k(T({},groupLabel(u,o,l)),{count:u.length});n(p,c),a.push(p)}return a.sort((i,c)=>(i.empty===c.empty?0:i.empty?1:-1)||c.count-i.count||cmp(i.label,c.label)),a}function descGroups(s,e,n){return tabGroups(s,e,(t,o)=>{t.html=String(o.h==null?"":o.h),t.empty=t.html.trim()===""},n)}function labelGroups(s,e,n){return tabGroups(s,e,(t,o)=>{const l=Array.isArray(o.l)?o.l:[],r=[];for(let a=0;a<l.length;a++){const i=l[a]||{},c=String(i.k==null?"":i.k);c!==""&&r.push({k:c,v:String(i.v==null?"":i.v)})}r.sort((a,i)=>cmp(a.k,i.k)),t.pairs=r,t.empty=r.length===0},n)}function descPanel(s){return s.empty?notice("description \u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002"):s.html}const tabText=s=>`${s.labelHtml}<span class="vg-tabn">${s.count}</span>`;function renderDesc(s,e,n){const t=descGroups(s,e,n),o='<div class="vg-nhead">View \u306E description</div>';if(!t.length)return`<div class="vg-nsec">${o}`+notice("View \u306E description \u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002INFORMATION_SCHEMA.TABLE_OPTIONS \u304C\u8AAD\u3081\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002")+"</div>";if(t.length===1)return`<div class="vg-nsec">${o}<div class="vg-dtablist"><span class="vg-dtab vg-dstatic">${tabText(t[0])}</span></div><div class="vg-dbox">${descPanel(t[0])}</div></div>`;const l=t.slice(0,16),r="vgd"+hashId((s&&s.base||"")+"|"+t.map(p=>p.label).join("|")),a=l.map((p,g)=>`<input class="vg-dr vg-dr${g+1}" type="radio" name="${r}" id="${r}-${g+1}"${g===0?" checked":""}>`).join(""),i=l.map((p,g)=>`<label class="vg-dtab vg-dt${g+1}" for="${r}-${g+1}">${tabText(p)}</label>`).join(""),c=l.map((p,g)=>`<div class="vg-dpanel vg-dp${g+1}">${descPanel(p)}</div>`).join(""),u=t.length>l.length?notice(`description \u304C\u591A\u3044\u305F\u3081\u5148\u982D 16 \u7A2E\u985E\u306E\u307F\u51FA\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${t.length} \u7A2E\u985E\uFF09\u3002`):"";return`<div class="vg-nsec">${o}${u}<div class="vg-dtabs">${a}<div class="vg-dtablist">${i}</div><div class="vg-dpanels">${c}</div></div></div>`}function labelChips(s){return s.empty?notice("\u30E9\u30D9\u30EB\u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002"):'<div class="vg-lbchips">'+s.pairs.map(e=>`<span class="vg-lbchip"><span class="vg-lbk">${esc(e.k)}</span><span class="vg-lbv">${esc(e.v||"(\u7A7A)")}</span></span>`).join("")+"</div>"}function labelsSplit(s,e){return labelGroups(s,e).length>1}function renderLabels(s,e,n){const t=labelGroups(s,e,n);if(!t.length||t[0].empty)return"";if(t.length===1)return labelChips(t[0]);const o=t.slice(0,8),l="vgl"+hashId((s&&s.base||"")+"|"+t.map(u=>u.label+"="+u.pairs.map(p=>p.k+":"+p.v).join(",")).join("|")),r=o.map((u,p)=>`<input class="vg-lbr vg-lbr${p+1}" type="radio" name="${l}" id="${l}-${p+1}"${p===0?" checked":""}>`).join(""),a=o.map((u,p)=>`<label class="vg-lbtab vg-lbt${p+1}" for="${l}-${p+1}">${tabText(u)}</label>`).join(""),i=o.map((u,p)=>`<div class="vg-lbpanel vg-lbp${p+1}">${labelChips(u)}</div>`).join(""),c=t.length>o.length?notice(`\u30E9\u30D9\u30EB\u306E\u7A2E\u985E\u304C\u591A\u3044\u305F\u3081\u5148\u982D 8 \u7A2E\u985E\u306E\u307F\u51FA\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${t.length} \u7A2E\u985E\uFF09\u3002`):"";return'<div class="vg-nsec"><div class="vg-nhead">\u30E9\u30D9\u30EB</div>'+notice("\u540C\u3058 base \u306E\u4E2D\u3067\u30E9\u30D9\u30EB\u304C\u5272\u308C\u3066\u3044\u307E\u3059\u3002")+c+`<div class="vg-lbtabs">${r}<div class="vg-lbtablist">${a}</div><div class="vg-lbpanels">${i}</div></div></div>`}function renderNote(s,e,n,t,o){const l=String(n==null?"":n);return renderLabels(s,t,o)+renderDesc(s,e,o)+`<div class="vg-nsec"><div class="vg-nhead">\u30E1\u30E2</div>${l}</div>`}function __opts(s){if(!s)return{};try{return JSON.parse(s)||{}}catch(e){return{}}}function __notice(s){return'<div class="vg-notice">'+String(s).replace(/[<>&]/g,"")+"</div>"}function __run(s,e,n,t,o,l,r,a,i){var c=__opts(i),u;try{u=JSON.parse(s)}catch($){u=null}if(!u)return String(e||__notice("\u89E3\u6790\u7D50\u679C\u3092\u8AAD\u307F\u53D6\u308C\u307E\u305B\u3093\u3067\u3057\u305F\u3002"));var p={};try{for(var g=JSON.parse(t)||[],h=0;h<g.length;h++)p[g[h].v]=g[h].cols||[]}catch($){p={}}var f={};try{for(var m=JSON.parse(o)||[],v=0;v<m.length;v++)f[m[v].v]=m[v].s}catch($){f={}}var w=[];try{w=JSON.parse(l)||[]}catch($){w=[]}var b=[];try{b=JSON.parse(r)||[]}catch($){b=[]}var S=[];try{S=JSON.parse(a)||[]}catch($){S=[]}for(var A="",x="",j=u.bases||[],_=0;_<j.length;_++)A+=renderColumnsBase(j[_],p),x+=renderSqlBase(j[_],f);A||(A=__notice("\u30AB\u30E9\u30E0\u5B9A\u7FA9\u3092\u51FA\u305B\u308B View \u304C\u3042\u308A\u307E\u305B\u3093\u3002")),x||(x=__notice("SQL \u3092\u51FA\u305B\u308B View \u304C\u3042\u308A\u307E\u305B\u3093\u3002"));var d=u.bases&&u.bases.length?u.bases[0]:null;return wrapPage(String(e||""),String(n||__notice("\u53C2\u7167\u95A2\u4FC2\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F\u3002")),A,x,renderNote(d,w,NOTE_MARK,b,S),d,labelsSplit(d,b))}return __run(analysis_json,diff_html,erd_html,columns_json,sql_json,descs_json,labels_json,regions_json,options_json);
