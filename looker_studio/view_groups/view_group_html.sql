...
var b=Object.defineProperty;var f=Object.getOwnPropertySymbols;var x=Object.prototype.hasOwnProperty,m=Object.prototype.propertyIsEnumerable;var h=(e,t,n)=>t in e?b(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,g=(e,t)=>{for(var n in t||(t={}))x.call(t,n)&&h(e,n,t[n]);if(f)for(var n of f(t))m.call(t,n)&&h(e,n,t[n]);return e};function diffLines(e,t){const n=e.length,o=t.length,r=[];for(let i=0;i<=n;i++)r.push(new Int32Array(o+1));for(let i=n-1;i>=0;i--)for(let p=o-1;p>=0;p--)r[i][p]=e[i]===t[p]?r[i+1][p+1]+1:Math.max(r[i+1][p],r[i][p+1]);const s=[];let a=0,d=0;for(;a<n&&d<o;)e[a]===t[d]?(s.push({type:"equal",aIndex:a,bIndex:d,text:e[a]}),a++,d++):r[a+1][d]>=r[a][d+1]?(s.push({type:"del",aIndex:a,text:e[a]}),a++):(s.push({type:"add",bIndex:d,text:t[d]}),d++);for(;a<n;)s.push({type:"del",aIndex:a,text:e[a]}),a++;for(;d<o;)s.push({type:"add",bIndex:d,text:t[d]}),d++;return s}function lcsMatchFlags(e,t){const n=e.length,o=t.length,r=[];for(let i=0;i<=n;i++)r.push(new Int32Array(o+1));for(let i=n-1;i>=0;i--)for(let p=o-1;p>=0;p--)r[i][p]=e[i]===t[p]?r[i+1][p+1]+1:Math.max(r[i+1][p],r[i][p+1]);const s=new Array(n).fill(!1);let a=0,d=0;for(;a<n&&d<o;)e[a]===t[d]?(s[a]=!0,a++,d++):r[a+1][d]>=r[a][d+1]?a++:d++;return s}function tokenize(e){return e.match(/([A-Za-z0-9_]+|\s+|[^\sA-Za-z0-9_])/g)||[]}function mergeSegs(e){const t=[];for(const n of e){const o=t[t.length-1];o&&o.hi===n.hi?o.text+=n.text:t.push({text:n.text,hi:n.hi})}return t}function segDiff(e,t){const n=e.length,o=t.length,r=[];for(let p=0;p<=n;p++)r.push(new Int32Array(o+1));for(let p=n-1;p>=0;p--)for(let l=o-1;l>=0;l--)r[p][l]=e[p]===t[l]?r[p+1][l+1]+1:Math.max(r[p+1][l],r[p][l+1]);const s=[],a=[];let d=0,i=0;for(;d<n&&i<o;)e[d]===t[i]?(s.push({text:e[d],hi:!1}),a.push({text:t[i],hi:!1}),d++,i++):r[d+1][i]>=r[d][i+1]?(s.push({text:e[d],hi:!0}),d++):(a.push({text:t[i],hi:!0}),i++);for(;d<n;)s.push({text:e[d],hi:!0}),d++;for(;i<o;)a.push({text:t[i],hi:!0}),i++;return{oldSegs:mergeSegs(s),newSegs:mergeSegs(a)}}function wordDiff(e,t){return segDiff(tokenize(e),tokenize(t))}function tokenizeName(e){return String(e).match(/([^._\-\s]+|[._\-\s])/g)||[]}function nameDiff(e){if(!Array.isArray(e)||e.length<2)return(e||[]).map(i=>[{text:String(i),hi:!1}]);if(e.length===2){const i=segDiff(tokenizeName(e[0]),tokenizeName(e[1]));return[i.oldSegs,i.newSegs]}const t=tokenizeName(e[0]),n=tokenizeName(e[1]),o=tokenizeName(e[2]),r=segDiff(t,n).newSegs,s=segDiff(t,o).newSegs,a=new Array(t.length).fill(!0);for(const i of[n,o]){const p=lcsMatchFlags(t,i);for(let l=0;l<t.length;l++)a[l]=a[l]&&p[l]}return[mergeSegs(t.map((i,p)=>({text:i,hi:!a[p]}))),r,s]}function build2Way(e,t){const n=diffLines(e,t),o=[];let r=0;for(;r<n.length;){if(n[r].type==="equal"){const i=n[r];o.push({type:"equal",left:{num:i.aIndex+1,segs:[{text:i.text,hi:!1}],kind:"plain"},right:{num:i.bIndex+1,segs:[{text:i.text,hi:!1}],kind:"plain"}}),r++;continue}const s=[];for(;r<n.length&&n[r].type==="del";)s.push(n[r++]);const a=[];for(;r<n.length&&n[r].type==="add";)a.push(n[r++]);const d=Math.max(s.length,a.length);for(let i=0;i<d;i++){const p=s[i],l=a[i];if(p&&l){const c=wordDiff(p.text,l.text);o.push({type:"mod",left:{num:p.aIndex+1,segs:c.oldSegs,kind:"del"},right:{num:l.bIndex+1,segs:c.newSegs,kind:"add"}})}else p?o.push({type:"del",left:{num:p.aIndex+1,segs:[{text:p.text,hi:!1}],kind:"del"},right:null}):o.push({type:"add",left:null,right:{num:l.bIndex+1,segs:[{text:l.text,hi:!1}],kind:"add"}})}}return o}function splitLines(e){const t=String(e).split(/\r\n|\r|\n/);return t.length>1&&t[t.length-1]===""&&t.pop(),t}const DEFAULT_FONT="'Roboto Mono','SFMono-Regular',Consolas,'Liberation Mono',Menlo,monospace",DEFAULTS={T:{font:DEFAULT_FONT,headFont:"'Roboto','Segoe UI',system-ui,-apple-system,sans-serif",fontSize:12,lineHeight:1.35,text:"#24292F",title:"#1A1A1A",num:"#B0BAC5",numBorder:"#ECEFF1",border:"#E0E0E0",headSub:"#90A4AE",emptyBg:"#FAFAFA",shadow:"0 1px 3px rgba(0,0,0,.10),0 1px 2px rgba(0,0,0,.18)",hatch:"background-color:#FAFAFA;background-image:repeating-linear-gradient(45deg,rgba(120,130,140,.10),rgba(120,130,140,.10) 3px,transparent 3px,transparent 7px);"},paneColors:{base:"#E17B7B",after:"#93AE68",ref:"#7E9BC8"},lineOpacity:.3,charOpacity:.55,S:{keyword:"#CF222E",literal:"#098658",comment:"#6E7781"},fontFamily:DEFAULT_FONT};let T=g({},DEFAULTS.T),PANES,S=g({},DEFAULTS.S);function isNum(e){return typeof e=="number"&&isFinite(e)}const HEX=/^#?[0-9a-fA-F]{3}([0-9a-fA-F]{3})?$/;function hexToRgb(e){e=e.replace("#",""),e.length===3&&(e=e.split("").map(n=>n+n).join(""));const t=parseInt(e,16);return[t>>16&255,t>>8&255,t&255]}function toHex(e,t,n){const o=r=>("0"+Math.round(Math.max(0,Math.min(255,r))).toString(16)).slice(-2);return"#"+o(e)+o(t)+o(n)}function mixWhite(e,t){const[n,o,r]=hexToRgb(e),s=a=>255+(a-255)*t;return toHex(s(n),s(o),s(r))}function darken(e,t){const[n,o,r]=hexToRgb(e),s=a=>a*(1-t);return toHex(s(n),s(o),s(r))}function buildPane(e,t,n){return{bg:mixWhite(e,t),hi:mixWhite(e,n),bar:e,mark:darken(e,.28),numBg:mixWhite(e,.05),headText:darken(e,.4),headBg:mixWhite(e,.14)}}function configure(e){T=g({},DEFAULTS.T),S=g({},DEFAULTS.S);const t=g({},DEFAULTS.paneColors);let n=DEFAULTS.lineOpacity,o=DEFAULTS.charOpacity;if(e){e.fontFamily&&(T.font=e.fontFamily),isNum(e.fontSize)&&(T.fontSize=e.fontSize),isNum(e.lineHeight)&&(T.lineHeight=e.lineHeight);const r=e.colors||{};HEX.test(r.baseColor||"")&&(t.base=r.baseColor),HEX.test(r.afterColor||"")&&(t.after=r.afterColor),HEX.test(r.refColor||"")&&(t.ref=r.refColor),isNum(e.diffLineOpacity)&&(n=e.diffLineOpacity),isNum(e.diffCharOpacity)&&(o=e.diffCharOpacity);const s=e.syntax||{};s.keyword&&(S.keyword=s.keyword),s.literal&&(S.literal=s.literal),s.comment&&(S.comment=s.comment)}PANES={base:buildPane(t.base,n,o),after:buildPane(t.after,n,o),ref:buildPane(t.ref,n,o)}}configure();const SQL_KEYWORDS=new Set("SELECT FROM WHERE JOIN INNER LEFT RIGHT FULL OUTER CROSS ON USING AND OR NOT IN IS NULL LIKE BETWEEN EXISTS ANY ALL SOME GROUP BY HAVING ORDER ASC DESC LIMIT OFFSET FETCH FIRST NEXT ONLY ROWS UNION INTERSECT EXCEPT DISTINCT AS CASE WHEN THEN ELSE END INSERT INTO VALUES UPDATE SET DELETE MERGE CREATE ALTER DROP TABLE VIEW INDEX WITH RECURSIVE OVER PARTITION ROW_NUMBER RANK DENSE_RANK INT INTEGER BIGINT SMALLINT DECIMAL NUMERIC VARCHAR CHAR TEXT DATE TIMESTAMP BOOLEAN PRIMARY KEY FOREIGN REFERENCES DEFAULT UNIQUE CHECK CONSTRAINT CASCADE TRUE FALSE COUNT SUM AVG MIN MAX COALESCE CAST".split(/\s+/));function escAttr(e){return esc(e).replace(/"/g,"&quot;")}const PARAM_HTML_RE=/\{(?:<[^>]+>)*\{(?:<[^>]+>)*(P\d+)(?:<[^>]+>)*\}(?:<[^>]+>)*\}/g;function withTips(e,t,n){if(!t)return e;const o=n?"vg-ph vg-phr":"vg-ph";return e.replace(PARAM_HTML_RE,(r,s)=>{const a=t[s];return a?`<span class="${o}" data-tip="${escAttr(a)}">${r}</span>`:r})}function sqlHighlight(e){const t=e.length;let n=0,o="";const r=(l,c,u)=>`<span style="color:${l};${u?"font-style:italic;":""}">${esc(c)}</span>`,s=l=>l===" "||l==="	",a=l=>l>="0"&&l<="9",d=l=>/[A-Za-z_]/.test(l),i=l=>/[A-Za-z0-9_]/.test(l),p=l=>"=<>!+-*/%|,.();:".indexOf(l)>=0;for(;n<t;){const l=e[n];if(s(l)){let c=n+1;for(;c<t&&s(e[c]);)c++;o+=esc(e.slice(n,c)),n=c;continue}if(l==="-"&&e[n+1]==="-"){o+=r(S.comment,e.slice(n),!0);break}if(l==="'"){let c=n+1;for(;c<t;){if(e[c]==="'"){if(e[c+1]==="'"){c+=2;continue}c++;break}c++}o+=r(S.literal,e.slice(n,c)),n=c;continue}if(a(l)){let c=n+1;for(;c<t&&(a(e[c])||e[c]===".");)c++;o+=r(S.literal,e.slice(n,c)),n=c;continue}if(d(l)){let c=n+1;for(;c<t&&i(e[c]);)c++;const u=e.slice(n,c);SQL_KEYWORDS.has(u.toUpperCase())?o+=r(S.keyword,u):o+=esc(u),n=c;continue}o+=esc(l),n++}return o}function renderSegs(e,t,n,o){if(!e||!e.length)return"&nbsp;";let r="";for(const s of e){const a=sqlHighlight(s.text);r+=s.hi?`<span style="background:${t};border-radius:2px;">${a}</span>`:a}return r===""?"&nbsp;":withTips(r,n,o)}function numTd(e,t,n){const o=n?`border-left:1px solid ${T.border};`:"";return`<td style="padding:0 10px;text-align:right;color:${T.num};background:${t.numBg};border-right:1px solid ${T.numBorder};${o}white-space:nowrap;">${e==null?"&nbsp;":e}</td>`}function markTd(e,t){return e==="add"?`<td style="padding:0 4px;text-align:center;color:${t.mark};">+</td>`:e==="del"?`<td style="padding:0 4px;text-align:center;color:${t.mark};">\u2212</td>`:`<td style="padding:0 4px;text-align:center;color:${T.headSub};">&nbsp;</td>`}function codeTd(e,t,n){let o=`padding:0 12px;white-space:pre-wrap;overflow-wrap:anywhere;color:${T.text};`;return(e==="add"||e==="del"||e==="diff")&&(o+=`background:${n.bg};border-left:2px solid ${n.bar};`),`<td style="${o}">${t||"&nbsp;"}</td>`}function hatchTd(e,t){const n=t?`border-left:1px solid ${T.border};`:"";return e==="num"?`<td style="padding:0 10px;border-right:1px solid ${T.numBorder};${n}${T.hatch}">&nbsp;</td>`:e==="mark"?`<td style="padding:0 4px;${T.hatch}">&nbsp;</td>`:`<td style="padding:0 12px;white-space:pre-wrap;${n}${T.hatch}">&nbsp;</td>`}function labelHtml(e,t){return typeof e=="string"&&(e=[{text:e,hi:!1}]),e.map(n=>n.hi?`<span style="background:${t.hi};border-radius:2px;">${esc(n.text)}</span>`:esc(n.text)).join("")}function th(e,t,n,o,r){const s=r?`border-left:1px solid ${T.border};`:"",a=n?`&nbsp;<span style="color:${o.headText};font-weight:400;">(${esc(n)})</span>`:"";return`<th colspan="${e}" style="text-align:left;font-family:${T.headFont};font-weight:600;color:${T.title};background:${o.headBg};border-bottom:2px solid ${o.bar};${s}padding:7px 12px;">${labelHtml(t,o)}${a}</th>`}function wrapTable(e,t,n,o){return`<div style="font-family:${T.font};color:${T.text};line-height:${T.lineHeight};-webkit-text-size-adjust:100%;-moz-text-size-adjust:100%;text-size-adjust:100%;">
...
`+n.markup}return e}function __run(e,t){var n=__opts(t),o;try{o=JSON.parse(e)}catch(d){o=null}if(!o)return __notice("\u89E3\u6790\u7D50\u679C\u3092\u8AAD\u307F\u53D6\u308C\u307E\u305B\u3093\u3067\u3057\u305F\u3002");for(var r=o.lead?__notice(o.lead):"",s=o.bases||[],a=0;a<s.length;a++)r+=renderBase(s[a],n);return o.tail&&(r+=__notice(o.tail)),__applyMode(r,n.mode||"inline")}return __run(analysis_json,options_json);

""";

DECLARE js_css STRING DEFAULT r"""
var v=Object.defineProperty;var x=Object.getOwnPropertySymbols;var E=Object.prototype.hasOwnProperty,$=Object.prototype.propertyIsEnumerable;var m=(e,t,n)=>t in e?v(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,g=(e,t)=>{for(var n in t||(t={}))E.call(t,n)&&m(e,n,t[n]);if(x)for(var n of x(t))$.call(t,n)&&m(e,n,t[n]);return e};function diffLines(e,t){const n=e.length,r=t.length,o=[];for(let i=0;i<=n;i++)o.push(new Int32Array(r+1));for(let i=n-1;i>=0;i--)for(let p=r-1;p>=0;p--)o[i][p]=e[i]===t[p]?o[i+1][p+1]+1:Math.max(o[i+1][p],o[i][p+1]);const s=[];let a=0,d=0;for(;a<n&&d<r;)e[a]===t[d]?(s.push({type:"equal",aIndex:a,bIndex:d,text:e[a]}),a++,d++):o[a+1][d]>=o[a][d+1]?(s.push({type:"del",aIndex:a,text:e[a]}),a++):(s.push({type:"add",bIndex:d,text:t[d]}),d++);for(;a<n;)s.push({type:"del",aIndex:a,text:e[a]}),a++;for(;d<r;)s.push({type:"add",bIndex:d,text:t[d]}),d++;return s}function lcsMatchFlags(e,t){const n=e.length,r=t.length,o=[];for(let i=0;i<=n;i++)o.push(new Int32Array(r+1));for(let i=n-1;i>=0;i--)for(let p=r-1;p>=0;p--)o[i][p]=e[i]===t[p]?o[i+1][p+1]+1:Math.max(o[i+1][p],o[i][p+1]);const s=new Array(n).fill(!1);let a=0,d=0;for(;a<n&&d<r;)e[a]===t[d]?(s[a]=!0,a++,d++):o[a+1][d]>=o[a][d+1]?a++:d++;return s}function tokenize(e){return e.match(/([A-Za-z0-9_]+|\s+|[^\sA-Za-z0-9_])/g)||[]}function mergeSegs(e){const t=[];for(const n of e){const r=t[t.length-1];r&&r.hi===n.hi?r.text+=n.text:t.push({text:n.text,hi:n.hi})}return t}function segDiff(e,t){const n=e.length,r=t.length,o=[];for(let p=0;p<=n;p++)o.push(new Int32Array(r+1));for(let p=n-1;p>=0;p--)for(let l=r-1;l>=0;l--)o[p][l]=e[p]===t[l]?o[p+1][l+1]+1:Math.max(o[p+1][l],o[p][l+1]);const s=[],a=[];let d=0,i=0;for(;d<n&&i<r;)e[d]===t[i]?(s.push({text:e[d],hi:!1}),a.push({text:t[i],hi:!1}),d++,i++):o[d+1][i]>=o[d][i+1]?(s.push({text:e[d],hi:!0}),d++):(a.push({text:t[i],hi:!0}),i++);for(;d<n;)s.push({text:e[d],hi:!0}),d++;for(;i<r;)a.push({text:t[i],hi:!0}),i++;return{oldSegs:mergeSegs(s),newSegs:mergeSegs(a)}}function wordDiff(e,t){return segDiff(tokenize(e),tokenize(t))}function tokenizeName(e){return String(e).match(/([^._\-\s]+|[._\-\s])/g)||[]}function nameDiff(e){if(!Array.isArray(e)||e.length<2)return(e||[]).map(i=>[{text:String(i),hi:!1}]);if(e.length===2){const i=segDiff(tokenizeName(e[0]),tokenizeName(e[1]));return[i.oldSegs,i.newSegs]}const t=tokenizeName(e[0]),n=tokenizeName(e[1]),r=tokenizeName(e[2]),o=segDiff(t,n).newSegs,s=segDiff(t,r).newSegs,a=new Array(t.length).fill(!0);for(const i of[n,r]){const p=lcsMatchFlags(t,i);for(let l=0;l<t.length;l++)a[l]=a[l]&&p[l]}return[mergeSegs(t.map((i,p)=>({text:i,hi:!a[p]}))),o,s]}function build2Way(e,t){const n=diffLines(e,t),r=[];let o=0;for(;o<n.length;){if(n[o].type==="equal"){const i=n[o];r.push({type:"equal",left:{num:i.aIndex+1,segs:[{text:i.text,hi:!1}],kind:"plain"},right:{num:i.bIndex+1,segs:[{text:i.text,hi:!1}],kind:"plain"}}),o++;continue}const s=[];for(;o<n.length&&n[o].type==="del";)s.push(n[o++]);const a=[];for(;o<n.length&&n[o].type==="add";)a.push(n[o++]);const d=Math.max(s.length,a.length);for(let i=0;i<d;i++){const p=s[i],l=a[i];if(p&&l){const c=wordDiff(p.text,l.text);r.push({type:"mod",left:{num:p.aIndex+1,segs:c.oldSegs,kind:"del"},right:{num:l.bIndex+1,segs:c.newSegs,kind:"add"}})}else p?r.push({type:"del",left:{num:p.aIndex+1,segs:[{text:p.text,hi:!1}],kind:"del"},right:null}):r.push({type:"add",left:null,right:{num:l.bIndex+1,segs:[{text:l.text,hi:!1}],kind:"add"}})}}return r}function splitLines(e){const t=String(e).split(/\r\n|\r|\n/);return t.length>1&&t[t.length-1]===""&&t.pop(),t}const DEFAULT_FONT="'Roboto Mono','SFMono-Regular',Consolas,'Liberation Mono',Menlo,monospace",DEFAULTS={T:{font:DEFAULT_FONT,headFont:"'Roboto','Segoe UI',system-ui,-apple-system,sans-serif",fontSize:12,lineHeight:1.35,text:"#24292F",title:"#1A1A1A",num:"#B0BAC5",numBorder:"#ECEFF1",border:"#E0E0E0",headSub:"#90A4AE",emptyBg:"#FAFAFA",shadow:"0 1px 3px rgba(0,0,0,.10),0 1px 2px rgba(0,0,0,.18)",hatch:"background-color:#FAFAFA;background-image:repeating-linear-gradient(45deg,rgba(120,130,140,.10),rgba(120,130,140,.10) 3px,transparent 3px,transparent 7px);"},paneColors:{base:"#E17B7B",after:"#93AE68",ref:"#7E9BC8"},lineOpacity:.3,charOpacity:.55,S:{keyword:"#CF222E",literal:"#098658",comment:"#6E7781"},fontFamily:DEFAULT_FONT};let T=g({},DEFAULTS.T),PANES,S=g({},DEFAULTS.S);function isNum(e){return typeof e=="number"&&isFinite(e)}const HEX=/^#?[0-9a-fA-F]{3}([0-9a-fA-F]{3})?$/;function hexToRgb(e){e=e.replace("#",""),e.length===3&&(e=e.split("").map(n=>n+n).join(""));const t=parseInt(e,16);return[t>>16&255,t>>8&255,t&255]}function toHex(e,t,n){const r=o=>("0"+Math.round(Math.max(0,Math.min(255,o))).toString(16)).slice(-2);return"#"+r(e)+r(t)+r(n)}function mixWhite(e,t){const[n,r,o]=hexToRgb(e),s=a=>255+(a-255)*t;return toHex(s(n),s(r),s(o))}function darken(e,t){const[n,r,o]=hexToRgb(e),s=a=>a*(1-t);return toHex(s(n),s(r),s(o))}function buildPane(e,t,n){return{bg:mixWhite(e,t),hi:mixWhite(e,n),bar:e,mark:darken(e,.28),numBg:mixWhite(e,.05),headText:darken(e,.4),headBg:mixWhite(e,.14)}}function configure(e){T=g({},DEFAULTS.T),S=g({},DEFAULTS.S);const t=g({},DEFAULTS.paneColors);let n=DEFAULTS.lineOpacity,r=DEFAULTS.charOpacity;if(e){e.fontFamily&&(T.font=e.fontFamily),isNum(e.fontSize)&&(T.fontSize=e.fontSize),isNum(e.lineHeight)&&(T.lineHeight=e.lineHeight);const o=e.colors||{};HEX.test(o.baseColor||"")&&(t.base=o.baseColor),HEX.test(o.afterColor||"")&&(t.after=o.afterColor),HEX.test(o.refColor||"")&&(t.ref=o.refColor),isNum(e.diffLineOpacity)&&(n=e.diffLineOpacity),isNum(e.diffCharOpacity)&&(r=e.diffCharOpacity);const s=e.syntax||{};s.keyword&&(S.keyword=s.keyword),s.literal&&(S.literal=s.literal),s.comment&&(S.comment=s.comment)}PANES={base:buildPane(t.base,n,r),after:buildPane(t.after,n,r),ref:buildPane(t.ref,n,r)}}configure();const SQL_KEYWORDS=new Set("SELECT FROM WHERE JOIN INNER LEFT RIGHT FULL OUTER CROSS ON USING AND OR NOT IN IS NULL LIKE BETWEEN EXISTS ANY ALL SOME GROUP BY HAVING ORDER ASC DESC LIMIT OFFSET FETCH FIRST NEXT ONLY ROWS UNION INTERSECT EXCEPT DISTINCT AS CASE WHEN THEN ELSE END INSERT INTO VALUES UPDATE SET DELETE MERGE CREATE ALTER DROP TABLE VIEW INDEX WITH RECURSIVE OVER PARTITION ROW_NUMBER RANK DENSE_RANK INT INTEGER BIGINT SMALLINT DECIMAL NUMERIC VARCHAR CHAR TEXT DATE TIMESTAMP BOOLEAN PRIMARY KEY FOREIGN REFERENCES DEFAULT UNIQUE CHECK CONSTRAINT CASCADE TRUE FALSE COUNT SUM AVG MIN MAX COALESCE CAST".split(/\s+/));function escAttr(e){return esc(e).replace(/"/g,"&quot;")}const PARAM_HTML_RE=/\{(?:<[^>]+>)*\{(?:<[^>]+>)*(P\d+)(?:<[^>]+>)*\}(?:<[^>]+>)*\}/g;function withTips(e,t,n){if(!t)return e;const r=n?"vg-ph vg-phr":"vg-ph";return e.replace(PARAM_HTML_RE,(o,s)=>{const a=t[s];return a?`<span class="${r}" data-tip="${escAttr(a)}">${o}</span>`:o})}function sqlHighlight(e){const t=e.length;let n=0,r="";const o=(l,c,u)=>`<span style="color:${l};${u?"font-style:italic;":""}">${esc(c)}</span>`,s=l=>l===" "||l==="	",a=l=>l>="0"&&l<="9",d=l=>/[A-Za-z_]/.test(l),i=l=>/[A-Za-z0-9_]/.test(l),p=l=>"=<>!+-*/%|,.();:".indexOf(l)>=0;for(;n<t;){const l=e[n];if(s(l)){let c=n+1;for(;c<t&&s(e[c]);)c++;r+=esc(e.slice(n,c)),n=c;continue}if(l==="-"&&e[n+1]==="-"){r+=o(S.comment,e.slice(n),!0);break}if(l==="'"){let c=n+1;for(;c<t;){if(e[c]==="'"){if(e[c+1]==="'"){c+=2;continue}c++;break}c++}r+=o(S.literal,e.slice(n,c)),n=c;continue}if(a(l)){let c=n+1;for(;c<t&&(a(e[c])||e[c]===".");)c++;r+=o(S.literal,e.slice(n,c)),n=c;continue}if(d(l)){let c=n+1;for(;c<t&&i(e[c]);)c++;const u=e.slice(n,c);SQL_KEYWORDS.has(u.toUpperCase())?r+=o(S.keyword,u):r+=esc(u),n=c;continue}r+=esc(l),n++}return r}function renderSegs(e,t,n,r){if(!e||!e.length)return"&nbsp;";let o="";for(const s of e){const a=sqlHighlight(s.text);o+=s.hi?`<span style="background:${t};border-radius:2px;">${a}</span>`:a}return o===""?"&nbsp;":withTips(o,n,r)}function numTd(e,t,n){const r=n?`border-left:1px solid ${T.border};`:"";return`<td style="padding:0 10px;text-align:right;color:${T.num};background:${t.numBg};border-right:1px solid ${T.numBorder};${r}white-space:nowrap;">${e==null?"&nbsp;":e}</td>`}function markTd(e,t){return e==="add"?`<td style="padding:0 4px;text-align:center;color:${t.mark};">+</td>`:e==="del"?`<td style="padding:0 4px;text-align:center;color:${t.mark};">\u2212</td>`:`<td style="padding:0 4px;text-align:center;color:${T.headSub};">&nbsp;</td>`}function codeTd(e,t,n){let r=`padding:0 12px;white-space:pre-wrap;overflow-wrap:anywhere;color:${T.text};`;return(e==="add"||e==="del"||e==="diff")&&(r+=`background:${n.bg};border-left:2px solid ${n.bar};`),`<td style="${r}">${t||"&nbsp;"}</td>`}function hatchTd(e,t){const n=t?`border-left:1px solid ${T.border};`:"";return e==="num"?`<td style="padding:0 10px;border-right:1px solid ${T.numBorder};${n}${T.hatch}">&nbsp;</td>`:e==="mark"?`<td style="padding:0 4px;${T.hatch}">&nbsp;</td>`:`<td style="padding:0 12px;white-space:pre-wrap;${n}${T.hatch}">&nbsp;</td>`}function labelHtml(e,t){return typeof e=="string"&&(e=[{text:e,hi:!1}]),e.map(n=>n.hi?`<span style="background:${t.hi};border-radius:2px;">${esc(n.text)}</span>`:esc(n.text)).join("")}function th(e,t,n,r,o){const s=o?`border-left:1px solid ${T.border};`:"",a=n?`&nbsp;<span style="color:${r.headText};font-weight:400;">(${esc(n)})</span>`:"";return`<th colspan="${e}" style="text-align:left;font-family:${T.headFont};font-weight:600;color:${T.title};background:${r.headBg};border-bottom:2px solid ${r.bar};${s}padding:7px 12px;">${labelHtml(t,r)}${a}</th>`}function wrapTable(e,t,n,r){return`<div style="font-family:${T.font};color:${T.text};line-height:${T.lineHeight};-webkit-text-size-adjust:100%;-moz-text-size-adjust:100%;text-size-adjust:100%;">
...
`}function renderFragment1(e,t,n,r,o){configure(r);const s='<colgroup><col style="width:40px"><col></colgroup>',a=th(2,e,t,PANES.base,!1);let d="";for(let i=0;i<n.length;i++)d+=`      <tr>${numTd(i+1,PANES.base,!1)}${codeTd("same",withTips(sqlHighlight(n[i]),o),PANES.base)}</tr>
`;return wrapTable(s,a,d,!!o)}function renderFragment2(e,t,n,r,o){configure(r);const s='<colgroup><col style="width:40px"><col style="width:22px"><col><col style="width:40px"><col style="width:22px"><col></colgroup>',a=nameDiff([e,t]),d=th(3,a[0],"before",PANES.base,!1)+th(3,a[1],"after",PANES.after,!0);let i="";for(const p of n){const l=p.left,c=p.right;let u="";l?u+=numTd(l.num,PANES.base,!1)+markTd(l.kind==="del"?"del":"blank",PANES.base)+codeTd(l.kind,renderSegs(l.segs,PANES.base.hi,o&&o.left),PANES.base):u+=hatchTd("num",!1)+hatchTd("mark",!1)+hatchTd("code",!1),c?u+=numTd(c.num,PANES.after,!0)+markTd(c.kind==="add"?"add":"blank",PANES.after)+codeTd(c.kind,renderSegs(c.segs,PANES.after.hi,o&&o.right,!0),PANES.after):u+=hatchTd("num",!0)+hatchTd("mark",!0)+hatchTd("code",!0),i+=`      <tr>${u}</tr>
`}return wrapTable(s,d,i,!!o)}const MAX_TABS=12;function esc(e){return String(e==null?"":e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function hashId(e){let t=2166136261;for(let n=0;n<String(e).length;n++)t^=String(e).charCodeAt(n),t=Math.imul(t,16777619)>>>0;return t.toString(36)}const label=e=>e.suffixes.map((t,n)=>t||e.members[n]&&e.members[n].viewName||"(suffix \u306A\u3057)").join(", ");function relabelPanes(e,t){let n=0;return e.replace(/(<span style="[^"]*font-weight:400;">)\((?:before|after|base|reference)\)(<\/span>)/g,(r,o,s)=>{const a=t[n++];return a==null?r:o+esc(a)+s})}const paneSub=e=>`${e.members.length} View`;function badge(e,t,n){return`<span class="vg-badge" style="color:${t};background:${n}">${esc(e)}</span>`}function header(e,t,n,r){const o=n>1;return`<div class="vg-header"><span class="vg-title">${esc(e)}</span>`+badge(`${t} View`,"#57606A","#EAEEF2")+badge(`${n} \u30B0\u30EB\u30FC\u30D7`,o?"#9A6700":"#1A7F37",o?"#FFF8C5":"#DAFBE1")+(r?badge("suffix \u672A\u8A8D\u8B58","#9A6700","#FFF8C5"):"")+"</div>"}function notice(e){return`<div class="vg-notice">${esc(e)}</div>`}const KIND_TEXT={entity:"\u5B9F\u4F53\u540D",string:"\u5024\uFF08\u6587\u5B57\u5217\uFF09",number:"\u5024\uFF08\u6570\u5024\uFF09",ident:"\u540D\u524D",quoted:"\u540D\u524D",keyword:"\u4E88\u7D04\u8A9E",punct:"\u8A18\u53F7",comment:"\u30B3\u30E1\u30F3\u30C8"},kindText=e=>KIND_TEXT[e]||e,REASON_TEXT={length:"\u30C8\u30FC\u30AF\u30F3\u6570\u304C\u9055\u3046\uFF08\u69CB\u9020\u305D\u306E\u3082\u306E\u304C\u5225\uFF09",kind:"\u30C8\u30FC\u30AF\u30F3\u306E\u7A2E\u985E\u304C\u9055\u3046","not-substitutable":"\u7F6E\u63DB\u3067\u304D\u306A\u3044\u30C8\u30FC\u30AF\u30F3\u304C\u9055\u3046\uFF08\u5217\u540D\u30FB\u5225\u540D\u30FBCTE \u540D\u30FB\u4E88\u7D04\u8A9E\u306A\u3069\u3002\u7F6E\u63DB\u3057\u3066\u3088\u3044\u306E\u306F FROM / JOIN \u306E\u5B9F\u4F53\u540D\u3068\u5024\u3060\u3051\uFF09",inconsistent:"\u540C\u3058\u30C8\u30FC\u30AF\u30F3\u304C\u5225\u306E\u5024\u306B\u5BFE\u5FDC\u3057\u3066\u3044\u3066\u4E00\u8CAB\u3057\u306A\u3044","not-injective":"\u5225\u3005\u306E\u30C8\u30FC\u30AF\u30F3\u304C\u540C\u3058\u5024\u306B\u5BFE\u5FDC\u3057\u3066\u3044\u3066 1 \u5BFE 1 \u306B\u306A\u3089\u306A\u3044"};function missTable(e){const t=s=>String(s==null?"":s).split("\0").join("\u27E8suffix\u27E9").replace(/\u0001(\d+)\u0001/g,"\u27E8\u540C\u5024\u30EA\u30C6\u30E9\u30EB $1 \u7D44\u76EE\u27E9"),n=e.filter(s=>s.miss).map(s=>{const a=s.miss.detail,d=a.reason==="length"?`${a.aLen} \u5BFE ${a.bLen}`:`<code class="vg-mcode">${esc(t(a.aText))}</code> \u2194 <code class="vg-mcode">${esc(t(a.bText))}</code><span class="vg-mkind">${esc(kindText(a.kind))}</span>`;return`<tr><th class="vg-mname">${esc(label(s))}</th><td class="vg-mvs">vs ${esc(s.miss.vs)}</td><td class="vg-mreason">${esc(REASON_TEXT[a.reason]||a.reason)}<br>${d}</td></tr>`}).join("");return n?`<details class="vg-params vg-miss"><summary class="vg-psummary">\u306A\u305C\u5225\u30B0\u30EB\u30FC\u30D7\u306B\u306A\u3063\u305F\u304B</summary>${e.some(s=>s.miss&&s.miss.detail.reason==="not-substitutable"&&(s.miss.detail.kind==="string"||s.miss.detail.kind==="number"))?'<div class="vg-mhint">\u5024\u306E\u9055\u3044\u3067\u5272\u308C\u3066\u3044\u307E\u3059\u3002\u65E2\u5B9A\u3067\u306F\u5024\u306F\u30D1\u30E9\u30E1\u30FC\u30BF\u5316\u3057\u3066\u540C\u3058\u30B0\u30EB\u30FC\u30D7\u306B\u3059\u308B\u306E\u3067\u3001<code class="vg-mcode">substitutable</code> \u3092\u7D5E\u3063\u305F\u8A2D\u5B9A\u306B\u306A\u3063\u3066\u3044\u307E\u3059\u3002\u65E2\u5B9A\u306B\u623B\u3059\u306A\u3089 options_json \u304B\u3089 <code class="vg-mcode">"substitutable"</code> \u3092\u5916\u3057\u307E\u3059\u3002<br>\u7D5E\u3063\u305F\u307E\u307E\u7279\u5B9A\u306E\u5024\u3060\u3051\u540C\u4E00\u8996\u3057\u305F\u3044\u306A\u3089\u3001<code class="vg-mcode">"equivalentLiterals": ["suffix", ["apac","amer","emea"]]</code> \u306E\u3088\u3046\u306B\u7D44\u3067\u4E26\u3079\u307E\u3059\uFF08<code class="vg-mcode">"suffix"</code> \u306F\u305D\u306E View \u81EA\u8EAB\u306E suffix \u3092\u8868\u3059\u4E88\u7D04\u8A9E\uFF09\u3002</div>':""}<div class="vg-pblock"><table class="vg-ptable">${n}</table></div></details>`:""}function paramsTable(e){return`<details class="vg-params"><summary class="vg-psummary">\u30D1\u30E9\u30E1\u30FC\u30BF\u5316\u3057\u305F\u7B87\u6240\uFF08\u30B0\u30EB\u30FC\u30D7\u5185\u3067\u7570\u306A\u308B\u30C8\u30FC\u30AF\u30F3\uFF09</summary>${e.map(n=>{if(!n.params.length)return`<div class="vg-pblock"><div class="vg-plabel">${esc(label(n))}</div><div class="vg-pnone">\u5DEE\u5206\u306A\u3057\uFF08\u5B8C\u5168\u4E00\u81F4\uFF09</div></div>`;const r=n.params.map(o=>{const s=Object.entries(o.values).map(([d,i])=>`<div class="vg-pv"><span class="vg-psuf">${esc(d)}</span>${esc(i)}</div>`).join(""),a=`<span class="vg-mkind">${esc(kindText(o.kind))}</span>`;return`<tr><th class="vg-pname">${esc(o.name)}</th><td class="vg-pvals">${a}${s}</td></tr>`}).join("");return`<div class="vg-pblock"><div class="vg-plabel">${esc(label(n))}</div><table class="vg-ptable">${r}</table></div>`}).join("")}</details>`}function paramTips(e){const t={};for(const n of e.params)t[n.name]=`${n.name}: ${kindText(n.kind)}
`+Object.entries(n.values).map(([r,o])=>`${r||"(suffix \u306A\u3057)"} = ${o}`).join(`
`);return t}function pair(e,t,n){return relabelPanes(renderFragment2(label(e),label(t),build2Way(splitLines(e.sql),splitLines(t.sql)),n,{left:paramTips(e),right:paramTips(t)}),[`\u57FA\u6E96 / ${paneSub(e)}`,paneSub(t)])}function baseTab(e){return`<span class="vg-tab vg-tbase"><span class="vg-tbadge">\u57FA\u6E96</span>${esc(label(e))}<span class="vg-tabn">${e.members.length}</span></span>`}function tabs(e,t,n){const[r,...o]=e,s=o.slice(0,MAX_TABS),a=s.map((l,c)=>`<input class="vg-r vg-r${c+1}" type="radio" name="${n}" id="${n}-${c+1}"${c===0?" checked":""}>`).join(""),d=baseTab(r)+s.map((l,c)=>`<label class="vg-tab vg-t${c+1}" for="${n}-${c+1}">${esc(label(l))}<span class="vg-tabn">${l.members.length}</span></label>`).join(""),i=s.length?s.map((l,c)=>`<div class="vg-panel vg-p${c+1}">${pair(r,l,t)}</div>`).join(""):`<div class="vg-single">${renderFragment1(label(r),paneSub(r),splitLines(r.sql),t,paramTips(r))}</div>`;return(o.length>s.length?notice(`\u30B0\u30EB\u30FC\u30D7\u304C\u591A\u3044\u305F\u3081\u5148\u982D ${MAX_TABS} \u4EF6\u306E\u307F\u30BF\u30D6\u8868\u793A\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${o.length} \u4EF6\uFF09\u3002`):"")+`<div class="vg-tabs">${a}<div class="vg-tablist">${d}</div><div class="vg-panels">${i}</div></div>`}function renderBase(e,t){const n=t||{},r=e.groups,o=r.length,s="vgt"+hashId(e.base+"|"+r.map(label).join("|"));let a;return o===0?a=notice("View \u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002"):a=(o>1?"":notice(e.unmatched?"suffix \u3092\u8A8D\u8B58\u3067\u304D\u306A\u304B\u3063\u305F View \u3067\u3059\u3002\u6BD4\u8F03\u76F8\u624B\u304C\u306A\u3044\u306E\u3067\u5358\u72EC\u3067\u8868\u793A\u3057\u3066\u3044\u307E\u3059\u3002":`${e.viewCount} View \u3059\u3079\u3066\u304C\u540C\u4E00\u30ED\u30B8\u30C3\u30AF\u3067\u3059\u3002\u6BD4\u8F03\u306E\u5FC5\u8981\u304C\u306A\u3044\u306E\u3067 SQL \u3060\u3051\u51FA\u3057\u3066\u3044\u307E\u3059\u3002`))+tabs(r,n,s),'<div class="vg-root">'+header(e.base,e.viewCount,o,e.unmatched)+a+missTable(r)+paramsTable(r)+"</div>"}function chromeCss(){const e=[".vg-root{font:13px/1.6 'Roboto','Segoe UI',system-ui,-apple-system,sans-serif;color:#24292F}",".vg-header{display:flex;align-items:center;flex-wrap:wrap;gap:8px;margin:0 0 10px}",".vg-title{font:600 15px/1.6 inherit;color:#1A1A1A}",".vg-badge{display:inline-block;padding:1px 8px;border-radius:10px;font-weight:600;font-size:12px}",".vg-notice{margin:8px 0;padding:8px 12px;border:1px solid #D0D7DE;border-left:4px solid #57606A;border-radius:4px;background:#F6F8FA;color:#57606A}",".vg-r{position:absolute;opacity:0;width:1px;height:1px;pointer-events:none}",".vg-tablist{display:flex;flex-wrap:wrap;gap:4px;border-bottom:1px solid #D0D7DE;margin-bottom:-1px}",".vg-tab{display:inline-flex;align-items:center;gap:6px;padding:6px 14px;border:1px solid transparent;border-bottom:none;border-radius:6px 6px 0 0;color:#57606A;cursor:pointer;user-select:none;font-weight:600}",".vg-tab:hover{background:#EAEEF2;color:#24292F}",".vg-tbase{background:#fbeded;border-color:#efb6b6;color:#24292F;cursor:default}",".vg-tbase:hover{background:#fbeded;color:#24292F}",".vg-tbadge{padding:0 6px;border-radius:8px;background:#f6d7d7;color:#87494a;font-size:11px;font-weight:600}",".vg-tabn{padding:0 6px;border-radius:8px;background:#EAEEF2;color:#57606A;font-size:11px}",".vg-panels{border:1px solid #D0D7DE;border-radius:0 6px 6px 6px;padding:10px;background:#fff}",".vg-panel{display:none}",".vg-params{margin:12px 0 0;border:1px solid #D0D7DE;border-radius:6px;background:#F6F8FA}",".vg-psummary{padding:8px 12px;cursor:pointer;color:#57606A;font-weight:600;font-size:12px}",".vg-pblock{padding:0 12px 10px}",".vg-plabel{font:600 12px/1.8 inherit;color:#24292F}",".vg-pnone{color:#57606A;font-size:12px}",".vg-ptable{border-collapse:collapse;width:100%}",".vg-pname{width:44px;text-align:left;vertical-align:top;padding:3px 8px 3px 0;color:#8250DF;font:600 12px/1.6 ui-monospace,SFMono-Regular,Consolas,monospace}",".vg-pvals{padding:3px 0}",".vg-pv{font:11px/1.6 ui-monospace,SFMono-Regular,Consolas,monospace;color:#57606A;word-break:break-all}",".vg-psuf{display:inline-block;min-width:44px;color:#24292F;font-weight:600}",".vg-mhint{padding:0 12px 8px;color:#57606A;font-size:12px}",".vg-mname{text-align:left;vertical-align:top;padding:3px 10px 3px 0;font:600 12px/1.6 inherit;color:#24292F;white-space:nowrap}",".vg-mvs{vertical-align:top;padding:3px 10px 3px 0;color:#57606A;font-size:12px;white-space:nowrap}",".vg-mreason{padding:3px 0;color:#57606A;font-size:12px}",".vg-mcode{padding:1px 5px;border-radius:3px;background:#FFEBE9;color:#82071E;font:11px/1.6 ui-monospace,SFMono-Regular,Consolas,monospace}",".vg-mkind{margin-left:6px;color:#8250DF;font-size:11px}",".vg-ph{position:relative;border-bottom:1px dotted #8250DF;cursor:help}",".vg-ph::after{content:attr(data-tip);display:none;position:absolute;z-index:20;left:0;top:calc(100% + 5px);width:max-content;max-width:340px;padding:6px 10px;border-radius:6px;background:#24292F;color:#fff;font:11px/1.7 ui-monospace,SFMono-Regular,Consolas,monospace;white-space:pre-wrap;overflow-wrap:anywhere;text-align:left;box-shadow:0 2px 10px rgba(0,0,0,.30);pointer-events:none}",".vg-ph:hover::after{display:block}",".vg-ph.vg-phr::after{left:auto;right:0}"];for(let t=1;t<=MAX_TABS;t++)e.push(`.vg-r${t}:checked ~ .vg-panels > .vg-p${t}{display:block}`),e.push(`.vg-r${t}:checked ~ .vg-tablist > .vg-t${t}{background:#fff;border-color:#D0D7DE;color:#24292F}`),e.push(`.vg-r${t}:checked ~ .vg-tablist > .vg-t${t} .vg-tabn{background:#DDF4FF;color:#0969DA}`);return e.join(`
`)}function __opts(e){if(!e)return{};try{return JSON.parse(e)||{}}catch(t){return{}}}function __notice(e){return'<div class="vg-notice">'+String(e).replace(/[<>&]/g,"")+"</div>"}function __hashClass(e){for(var t=2166136261,n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619)>>>0;return"d"+t.toString(36)}function __split(e){var t={},n=e.replace(/ style="([^"]*)"/g,function(r,o){var s=__hashClass(o);return t[s]=o,' class="'+s+'"'});return{markup:n,rules:t}}function __rulesToCss(e){for(var t=Object.keys(e).sort(),n=[],r=0;r<t.length;r++)n.push("."+t[r]+"{"+e[t[r]]+"}");return n.join(`
`)}function __applyMode(e,t){if(t==="class")return __split(e).markup;if(t==="embed"){var n=__split(e);return`<style>
`+chromeCss()+`
`+__rulesToCss(n.rules)+`
</style>
`+n.markup}return e}function __fixtureRules(e){var t={};function n(l){var c=__split(renderBase(l,e)).rules;for(var u in c)t[u]=c[u]}function r(l,c,u,h){for(var f=[],b=0;b<l.length;b++)f.push({viewName:"v_fixture_"+l[b]});return{suffixes:l,members:f,sql:c,params:u||[],miss:h}}function o(l,c,u){for(var h=0,f=0;f<c.length;f++)h+=c[f].members.length;return{base:l,viewCount:h,groupCount:c.length,unmatched:u,groups:c}}var s=`SELECT
  a,
  b
FROM t_{{P1}}
WHERE x = 1`,a=`SELECT
...
WHERE x = 2`,d=`SELECT
  a
FROM t_{{P1}}
WHERE x = 1`,i=[{name:"{{P1}}",values:{abjp:"t_abjp",abus:"t_abus"}}],p={vs:"abjp, abus",detail:{reason:"not-substitutable",kind:"string",aText:"'apac'",bText:"'amer'"}};return n(o("v_fixture_one",[r(["abjp","abus"],s,[])])),n(o("v_fixture_two",[r(["abjp","abus"],s,i),r(["cdjp"],a,i,p)])),n(o("v_fixture_many",[r(["abjp","abus"],s,i),r(["cdjp"],a,i,p),r(["efjp"],d,i,p)])),n(o("v_fixture_no_suffix",[{suffixes:[null],members:[{viewName:"v_fixture_no_suffix"}],sql:s,params:[]}],!0)),t}return chromeCss()+`
