...
var b=Object.defineProperty;var f=Object.getOwnPropertySymbols;var x=Object.prototype.hasOwnProperty,m=Object.prototype.propertyIsEnumerable;var h=(e,t,n)=>t in e?b(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,g=(e,t)=>{for(var n in t||(t={}))x.call(t,n)&&h(e,n,t[n]);if(f)for(var n of f(t))m.call(t,n)&&h(e,n,t[n]);return e};function diffLines(e,t){const n=e.length,r=t.length,o=[];for(let s=0;s<=n;s++)o.push(new Int32Array(r+1));for(let s=n-1;s>=0;s--)for(let l=r-1;l>=0;l--)o[s][l]=e[s]===t[l]?o[s+1][l+1]+1:Math.max(o[s+1][l],o[s][l+1]);const i=[];let a=0,d=0;for(;a<n&&d<r;)e[a]===t[d]?(i.push({type:"equal",aIndex:a,bIndex:d,text:e[a]}),a++,d++):o[a+1][d]>=o[a][d+1]?(i.push({type:"del",aIndex:a,text:e[a]}),a++):(i.push({type:"add",bIndex:d,text:t[d]}),d++);for(;a<n;)i.push({type:"del",aIndex:a,text:e[a]}),a++;for(;d<r;)i.push({type:"add",bIndex:d,text:t[d]}),d++;return i}function lcsMatchFlags(e,t){const n=e.length,r=t.length,o=[];for(let s=0;s<=n;s++)o.push(new Int32Array(r+1));for(let s=n-1;s>=0;s--)for(let l=r-1;l>=0;l--)o[s][l]=e[s]===t[l]?o[s+1][l+1]+1:Math.max(o[s+1][l],o[s][l+1]);const i=new Array(n).fill(!1);let a=0,d=0;for(;a<n&&d<r;)e[a]===t[d]?(i[a]=!0,a++,d++):o[a+1][d]>=o[a][d+1]?a++:d++;return i}function tokenize(e){return e.match(/([A-Za-z0-9_]+|\s+|[^\sA-Za-z0-9_])/g)||[]}function mergeSegs(e){const t=[];for(const n of e){const r=t[t.length-1];r&&r.hi===n.hi?r.text+=n.text:t.push({text:n.text,hi:n.hi})}return t}function segDiff(e,t){const n=e.length,r=t.length,o=[];for(let l=0;l<=n;l++)o.push(new Int32Array(r+1));for(let l=n-1;l>=0;l--)for(let c=r-1;c>=0;c--)o[l][c]=e[l]===t[c]?o[l+1][c+1]+1:Math.max(o[l+1][c],o[l][c+1]);const i=[],a=[];let d=0,s=0;for(;d<n&&s<r;)e[d]===t[s]?(i.push({text:e[d],hi:!1}),a.push({text:t[s],hi:!1}),d++,s++):o[d+1][s]>=o[d][s+1]?(i.push({text:e[d],hi:!0}),d++):(a.push({text:t[s],hi:!0}),s++);for(;d<n;)i.push({text:e[d],hi:!0}),d++;for(;s<r;)a.push({text:t[s],hi:!0}),s++;return{oldSegs:mergeSegs(i),newSegs:mergeSegs(a)}}function wordDiff(e,t){return segDiff(tokenize(e),tokenize(t))}function tokenizeName(e){return String(e).match(/([^._\-\s]+|[._\-\s])/g)||[]}function nameDiff(e){if(!Array.isArray(e)||e.length<2)return(e||[]).map(s=>[{text:String(s),hi:!1}]);if(e.length===2){const s=segDiff(tokenizeName(e[0]),tokenizeName(e[1]));return[s.oldSegs,s.newSegs]}const t=tokenizeName(e[0]),n=tokenizeName(e[1]),r=tokenizeName(e[2]),o=segDiff(t,n).newSegs,i=segDiff(t,r).newSegs,a=new Array(t.length).fill(!0);for(const s of[n,r]){const l=lcsMatchFlags(t,s);for(let c=0;c<t.length;c++)a[c]=a[c]&&l[c]}return[mergeSegs(t.map((s,l)=>({text:s,hi:!a[l]}))),o,i]}function build2Way(e,t){const n=diffLines(e,t),r=[];let o=0;for(;o<n.length;){if(n[o].type==="equal"){const s=n[o];r.push({type:"equal",left:{num:s.aIndex+1,segs:[{text:s.text,hi:!1}],kind:"plain"},right:{num:s.bIndex+1,segs:[{text:s.text,hi:!1}],kind:"plain"}}),o++;continue}const i=[];for(;o<n.length&&n[o].type==="del";)i.push(n[o++]);const a=[];for(;o<n.length&&n[o].type==="add";)a.push(n[o++]);const d=Math.max(i.length,a.length);for(let s=0;s<d;s++){const l=i[s],c=a[s];if(l&&c){const p=wordDiff(l.text,c.text);r.push({type:"mod",left:{num:l.aIndex+1,segs:p.oldSegs,kind:"del"},right:{num:c.bIndex+1,segs:p.newSegs,kind:"add"}})}else l?r.push({type:"del",left:{num:l.aIndex+1,segs:[{text:l.text,hi:!1}],kind:"del"},right:null}):r.push({type:"add",left:null,right:{num:c.bIndex+1,segs:[{text:c.text,hi:!1}],kind:"add"}})}}return r}function splitLines(e){const t=String(e).split(/\r\n|\r|\n/);return t.length>1&&t[t.length-1]===""&&t.pop(),t}const DEFAULT_FONT="'Roboto Mono','SFMono-Regular',Consolas,'Liberation Mono',Menlo,monospace",DEFAULTS={T:{font:DEFAULT_FONT,headFont:"'Roboto','Segoe UI',system-ui,-apple-system,sans-serif",fontSize:12,lineHeight:1.35,text:"#24292F",title:"#1A1A1A",num:"#B0BAC5",numBorder:"#ECEFF1",border:"#E0E0E0",headSub:"#90A4AE",emptyBg:"#FAFAFA",shadow:"0 1px 3px rgba(0,0,0,.10),0 1px 2px rgba(0,0,0,.18)",hatch:"background-color:#FAFAFA;background-image:repeating-linear-gradient(45deg,rgba(120,130,140,.10),rgba(120,130,140,.10) 3px,transparent 3px,transparent 7px);"},paneColors:{base:"#E17B7B",after:"#93AE68",ref:"#7E9BC8"},lineOpacity:.3,charOpacity:.55,S:{keyword:"#CF222E",literal:"#098658",comment:"#6E7781"},fontFamily:DEFAULT_FONT};let T=g({},DEFAULTS.T),PANES,S=g({},DEFAULTS.S);function isNum(e){return typeof e=="number"&&isFinite(e)}const HEX=/^#?[0-9a-fA-F]{3}([0-9a-fA-F]{3})?$/;function hexToRgb(e){e=e.replace("#",""),e.length===3&&(e=e.split("").map(n=>n+n).join(""));const t=parseInt(e,16);return[t>>16&255,t>>8&255,t&255]}function toHex(e,t,n){const r=o=>("0"+Math.round(Math.max(0,Math.min(255,o))).toString(16)).slice(-2);return"#"+r(e)+r(t)+r(n)}function mixWhite(e,t){const[n,r,o]=hexToRgb(e),i=a=>255+(a-255)*t;return toHex(i(n),i(r),i(o))}function darken(e,t){const[n,r,o]=hexToRgb(e),i=a=>a*(1-t);return toHex(i(n),i(r),i(o))}function buildPane(e,t,n){return{bg:mixWhite(e,t),hi:mixWhite(e,n),bar:e,mark:darken(e,.28),numBg:mixWhite(e,.05),headText:darken(e,.4),headBg:mixWhite(e,.14)}}function configure(e){T=g({},DEFAULTS.T),S=g({},DEFAULTS.S);const t=g({},DEFAULTS.paneColors);let n=DEFAULTS.lineOpacity,r=DEFAULTS.charOpacity;if(e){e.fontFamily&&(T.font=e.fontFamily),isNum(e.fontSize)&&(T.fontSize=e.fontSize),isNum(e.lineHeight)&&(T.lineHeight=e.lineHeight);const o=e.colors||{};HEX.test(o.baseColor||"")&&(t.base=o.baseColor),HEX.test(o.afterColor||"")&&(t.after=o.afterColor),HEX.test(o.refColor||"")&&(t.ref=o.refColor),isNum(e.diffLineOpacity)&&(n=e.diffLineOpacity),isNum(e.diffCharOpacity)&&(r=e.diffCharOpacity);const i=e.syntax||{};i.keyword&&(S.keyword=i.keyword),i.literal&&(S.literal=i.literal),i.comment&&(S.comment=i.comment)}PANES={base:buildPane(t.base,n,r),after:buildPane(t.after,n,r),ref:buildPane(t.ref,n,r)}}configure();const SQL_KEYWORDS=new Set("SELECT FROM WHERE JOIN INNER LEFT RIGHT FULL OUTER CROSS ON USING AND OR NOT IN IS NULL LIKE BETWEEN EXISTS ANY ALL SOME GROUP BY HAVING ORDER ASC DESC LIMIT OFFSET FETCH FIRST NEXT ONLY ROWS UNION INTERSECT EXCEPT DISTINCT AS CASE WHEN THEN ELSE END INSERT INTO VALUES UPDATE SET DELETE MERGE CREATE ALTER DROP TABLE VIEW INDEX WITH RECURSIVE OVER PARTITION ROW_NUMBER RANK DENSE_RANK INT INTEGER BIGINT SMALLINT DECIMAL NUMERIC VARCHAR CHAR TEXT DATE TIMESTAMP BOOLEAN PRIMARY KEY FOREIGN REFERENCES DEFAULT UNIQUE CHECK CONSTRAINT CASCADE TRUE FALSE COUNT SUM AVG MIN MAX COALESCE CAST".split(/\s+/));function escAttr(e){return esc(e).replace(/"/g,"&quot;")}const PARAM_HTML_RE=/\{(?:<[^>]+>)*\{(?:<[^>]+>)*(P\d+)(?:<[^>]+>)*\}(?:<[^>]+>)*\}/g;function withTips(e,t,n){if(!t)return e;const r=n?"vg-ph vg-phr":"vg-ph";return e.replace(PARAM_HTML_RE,(o,i)=>{const a=t[i];return a?`<span class="${r}" data-tip="${escAttr(a)}">${o}</span>`:o})}function sqlHighlight(e){const t=e.length;let n=0,r="";const o=(c,p,u)=>`<span style="color:${c};${u?"font-style:italic;":""}">${esc(p)}</span>`,i=c=>c===" "||c==="	",a=c=>c>="0"&&c<="9",d=c=>/[A-Za-z_]/.test(c),s=c=>/[A-Za-z0-9_]/.test(c),l=c=>"=<>!+-*/%|,.();:".indexOf(c)>=0;for(;n<t;){const c=e[n];if(i(c)){let p=n+1;for(;p<t&&i(e[p]);)p++;r+=esc(e.slice(n,p)),n=p;continue}if(c==="-"&&e[n+1]==="-"){r+=o(S.comment,e.slice(n),!0);break}if(c==="'"){let p=n+1;for(;p<t;){if(e[p]==="'"){if(e[p+1]==="'"){p+=2;continue}p++;break}p++}r+=o(S.literal,e.slice(n,p)),n=p;continue}if(a(c)){let p=n+1;for(;p<t&&(a(e[p])||e[p]===".");)p++;r+=o(S.literal,e.slice(n,p)),n=p;continue}if(d(c)){let p=n+1;for(;p<t&&s(e[p]);)p++;const u=e.slice(n,p);SQL_KEYWORDS.has(u.toUpperCase())?r+=o(S.keyword,u):r+=esc(u),n=p;continue}r+=esc(c),n++}return r}function renderSegs(e,t,n,r){if(!e||!e.length)return"&nbsp;";let o="";for(const i of e){const a=sqlHighlight(i.text);o+=i.hi?`<span style="background:${t};border-radius:2px;">${a}</span>`:a}return o===""?"&nbsp;":withTips(o,n,r)}function numTd(e,t,n){const r=n?`border-left:1px solid ${T.border};`:"";return`<td style="padding:0 10px;text-align:right;color:${T.num};background:${t.numBg};border-right:1px solid ${T.numBorder};${r}white-space:nowrap;">${e==null?"&nbsp;":e}</td>`}function markTd(e,t){return e==="add"?`<td style="padding:0 4px;text-align:center;color:${t.mark};">+</td>`:e==="del"?`<td style="padding:0 4px;text-align:center;color:${t.mark};">\u2212</td>`:`<td style="padding:0 4px;text-align:center;color:${T.headSub};">&nbsp;</td>`}function codeTd(e,t,n){let r=`padding:0 12px;white-space:pre-wrap;overflow-wrap:anywhere;color:${T.text};`;return(e==="add"||e==="del"||e==="diff")&&(r+=`background:${n.bg};border-left:2px solid ${n.bar};`),`<td style="${r}">${t||"&nbsp;"}</td>`}function hatchTd(e,t){const n=t?`border-left:1px solid ${T.border};`:"";return e==="num"?`<td style="padding:0 10px;border-right:1px solid ${T.numBorder};${n}${T.hatch}">&nbsp;</td>`:e==="mark"?`<td style="padding:0 4px;${T.hatch}">&nbsp;</td>`:`<td style="padding:0 12px;white-space:pre-wrap;${n}${T.hatch}">&nbsp;</td>`}function labelHtml(e,t){return typeof e=="string"&&(e=[{text:e,hi:!1}]),e.map(n=>n.hi?`<span style="background:${t.hi};border-radius:2px;">${esc(n.text)}</span>`:esc(n.text)).join("")}function th(e,t,n,r,o){const i=o?`border-left:1px solid ${T.border};`:"",a=n?`&nbsp;<span style="color:${r.headText};font-weight:400;">(${esc(n)})</span>`:"";return`<th colspan="${e}" style="text-align:left;font-family:${T.headFont};font-weight:600;color:${T.title};background:${r.headBg};border-bottom:2px solid ${r.bar};${i}padding:7px 12px;">${labelHtml(t,r)}${a}</th>`}function wrapTable(e,t,n,r){return`<div style="font-family:${T.font};color:${T.text};line-height:${T.lineHeight};-webkit-text-size-adjust:100%;-moz-text-size-adjust:100%;text-size-adjust:100%;">
...
`}function renderFragment1(e,t,n,o,r){configure(o);const i='<colgroup><col style="width:40px"><col></colgroup>',s=th(2,e,t,PANES.base,!1);let p="";for(let a=0;a<n.length;a++)p+=`      <tr>${numTd(a+1,PANES.base,!1)}${codeTd("same",withTips(sqlHighlight(n[a]),r),PANES.base)}</tr>
`;return wrapTable(i,s,p,!!r)}function renderFragment2(e,t,n,o,r){configure(o);const i='<colgroup><col style="width:40px"><col style="width:22px"><col><col style="width:40px"><col style="width:22px"><col></colgroup>',s=nameDiff([e,t]),p=th(3,s[0],"before",PANES.base,!1)+th(3,s[1],"after",PANES.after,!0);let a="";for(const l of n){const c=l.left,d=l.right;let u="";c?u+=numTd(c.num,PANES.base,!1)+markTd(c.kind==="del"?"del":"blank",PANES.base)+codeTd(c.kind,renderSegs(c.segs,PANES.base.hi,r&&r.left),PANES.base):u+=hatchTd("num",!1)+hatchTd("mark",!1)+hatchTd("code",!1),d?u+=numTd(d.num,PANES.after,!0)+markTd(d.kind==="add"?"add":"blank",PANES.after)+codeTd(d.kind,renderSegs(d.segs,PANES.after.hi,r&&r.right,!0),PANES.after):u+=hatchTd("num",!0)+hatchTd("mark",!0)+hatchTd("code",!0),a+=`      <tr>${u}</tr>
`}return wrapTable(i,p,a,!!r)}const MAX_TABS=12;function esc(e){return String(e==null?"":e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function hashId(e){let t=2166136261;for(let n=0;n<String(e).length;n++)t^=String(e).charCodeAt(n),t=Math.imul(t,16777619)>>>0;return t.toString(36)}const label=e=>e.suffixes.map((t,n)=>t||e.members[n]&&e.members[n].viewName||"(suffix \u306A\u3057)").join(", ");function relabelPanes(e,t){let n=0;return e.replace(/(<span style="[^"]*font-weight:400;">)\((?:before|after|base|reference)\)(<\/span>)/g,(o,r,i)=>{const s=t[n++];return s==null?o:r+esc(s)+i})}const paneSub=e=>`${e.members.length} View`;function badge(e,t,n){return`<span class="vg-badge" style="color:${t};background:${n}">${esc(e)}</span>`}function header(e,t,n,o){const r=n>1;return`<div class="vg-header"><span class="vg-title">${esc(e)}</span>`+badge(`${t} View`,"#57606A","#EAEEF2")+badge(`${n} \u30B0\u30EB\u30FC\u30D7`,r?"#9A6700":"#1A7F37",r?"#FFF8C5":"#DAFBE1")+(o?badge("suffix \u672A\u8A8D\u8B58","#9A6700","#FFF8C5"):"")+"</div>"}function notice(e){return`<div class="vg-notice">${esc(e)}</div>`}const KIND_TEXT={entity:"\u5B9F\u4F53\u540D",string:"\u5024\uFF08\u6587\u5B57\u5217\uFF09",number:"\u5024\uFF08\u6570\u5024\uFF09",ident:"\u540D\u524D",quoted:"\u540D\u524D",keyword:"\u4E88\u7D04\u8A9E",punct:"\u8A18\u53F7",comment:"\u30B3\u30E1\u30F3\u30C8"},kindText=e=>KIND_TEXT[e]||e,REASON_TEXT={length:"\u30C8\u30FC\u30AF\u30F3\u6570\u304C\u9055\u3046\uFF08\u69CB\u9020\u305D\u306E\u3082\u306E\u304C\u5225\uFF09",kind:"\u30C8\u30FC\u30AF\u30F3\u306E\u7A2E\u985E\u304C\u9055\u3046","not-substitutable":"\u7F6E\u63DB\u3067\u304D\u306A\u3044\u30C8\u30FC\u30AF\u30F3\u304C\u9055\u3046\uFF08\u5217\u540D\u30FB\u5225\u540D\u30FBCTE \u540D\u30FB\u4E88\u7D04\u8A9E\u306A\u3069\u3002\u7F6E\u63DB\u3057\u3066\u3088\u3044\u306E\u306F FROM / JOIN \u306E\u5B9F\u4F53\u540D\u3068\u5024\u3060\u3051\uFF09",inconsistent:"\u540C\u3058\u30C8\u30FC\u30AF\u30F3\u304C\u5225\u306E\u5024\u306B\u5BFE\u5FDC\u3057\u3066\u3044\u3066\u4E00\u8CAB\u3057\u306A\u3044","not-injective":"\u5225\u3005\u306E\u30C8\u30FC\u30AF\u30F3\u304C\u540C\u3058\u5024\u306B\u5BFE\u5FDC\u3057\u3066\u3044\u3066 1 \u5BFE 1 \u306B\u306A\u3089\u306A\u3044"};function missTable(e,t,n){const o=a=>String(a==null?"":a).split("\0").join("\u27E8suffix\u27E9").replace(/\u0001(\d+)\u0001/g,"\u27E8\u540C\u5024\u30EA\u30C6\u30E9\u30EB $1 \u7D44\u76EE\u27E9"),r=a=>a.missBy?a.missBy[t]:a.miss,i=e.filter(a=>r(a)).map(a=>{const l=r(a).detail,c=l.reason==="length"?`${l.aLen} \u5BFE ${l.bLen}`:`<code class="vg-mcode">${esc(o(l.aText))}</code> \u2194 <code class="vg-mcode">${esc(o(l.bText))}</code><span class="vg-mkind">${esc(kindText(l.kind))}</span>`;return`<tr><th class="vg-mname">${esc(label(a))}</th><td class="vg-mvs">vs ${esc(n)}</td><td class="vg-mreason">${esc(REASON_TEXT[l.reason]||l.reason)}<br>${c}</td></tr>`}).join("");return i?`<details class="vg-params vg-miss"><summary class="vg-psummary">\u306A\u305C\u5225\u30B0\u30EB\u30FC\u30D7\u306B\u306A\u3063\u305F\u304B</summary>${e.some(a=>r(a)&&r(a).detail.reason==="not-substitutable"&&(r(a).detail.kind==="string"||r(a).detail.kind==="number"))?'<div class="vg-mhint">\u5024\u306E\u9055\u3044\u3067\u5272\u308C\u3066\u3044\u307E\u3059\u3002\u65E2\u5B9A\u3067\u306F\u5024\u306F\u30D1\u30E9\u30E1\u30FC\u30BF\u5316\u3057\u3066\u540C\u3058\u30B0\u30EB\u30FC\u30D7\u306B\u3059\u308B\u306E\u3067\u3001<code class="vg-mcode">substitutable</code> \u3092\u7D5E\u3063\u305F\u8A2D\u5B9A\u306B\u306A\u3063\u3066\u3044\u307E\u3059\u3002\u65E2\u5B9A\u306B\u623B\u3059\u306A\u3089 options_json \u304B\u3089 <code class="vg-mcode">"substitutable"</code> \u3092\u5916\u3057\u307E\u3059\u3002<br>\u7D5E\u3063\u305F\u307E\u307E\u7279\u5B9A\u306E\u5024\u3060\u3051\u540C\u4E00\u8996\u3057\u305F\u3044\u306A\u3089\u3001<code class="vg-mcode">"equivalentLiterals": ["suffix", ["apac","amer","emea"]]</code> \u306E\u3088\u3046\u306B\u7D44\u3067\u4E26\u3079\u307E\u3059\uFF08<code class="vg-mcode">"suffix"</code> \u306F\u305D\u306E View \u81EA\u8EAB\u306E suffix \u3092\u8868\u3059\u4E88\u7D04\u8A9E\uFF09\u3002</div>':""}<div class="vg-pblock"><table class="vg-ptable">${i}</table></div></details>`:""}function paramsTable(e){return`<details class="vg-params"><summary class="vg-psummary">\u30D1\u30E9\u30E1\u30FC\u30BF\u5316\u3057\u305F\u7B87\u6240\uFF08\u30B0\u30EB\u30FC\u30D7\u5185\u3067\u7570\u306A\u308B\u30C8\u30FC\u30AF\u30F3\uFF09</summary>${e.map(n=>{if(!n.params.length)return`<div class="vg-pblock"><div class="vg-plabel">${esc(label(n))}</div><div class="vg-pnone">\u5DEE\u5206\u306A\u3057\uFF08\u5B8C\u5168\u4E00\u81F4\uFF09</div></div>`;const o=n.params.map(r=>{const i=Object.entries(r.values).map(([p,a])=>`<div class="vg-pv"><span class="vg-psuf">${esc(p)}</span>${esc(a)}</div>`).join(""),s=`<span class="vg-mkind">${esc(kindText(r.kind))}</span>`;return`<tr><th class="vg-pname">${esc(r.name)}</th><td class="vg-pvals">${s}${i}</td></tr>`}).join("");return`<div class="vg-pblock"><div class="vg-plabel">${esc(label(n))}</div><table class="vg-ptable">${o}</table></div>`}).join("")}</details>`}function paramTips(e){const t={};for(const n of e.params)t[n.name]=`${n.name}: ${kindText(n.kind)}
`+Object.entries(n.values).map(([o,r])=>`${o||"(suffix \u306A\u3057)"} = ${r}`).join(`
`);return t}function pair(e,t,n){return relabelPanes(renderFragment2(label(e),label(t),build2Way(splitLines(e.sql),splitLines(t.sql)),n,{left:paramTips(e),right:paramTips(t)}),[`\u57FA\u6E96 / ${paneSub(e)}`,paneSub(t)])}function baseTab(e){return`<span class="vg-tab vg-tbase"><span class="vg-tbadge">\u57FA\u6E96</span>${esc(label(e))}<span class="vg-tabn">${e.members.length}</span></span>`}function tabs(e,t,n,o){const r=e[t],i=e.filter((d,u)=>u!==t),s=i.slice(0,MAX_TABS),p=s.map((d,u)=>`<input class="vg-r vg-r${u+1}" type="radio" name="${o}" id="${o}-${u+1}"${u===0?" checked":""}>`).join(""),a=baseTab(r)+s.map((d,u)=>`<label class="vg-tab vg-t${u+1}" for="${o}-${u+1}">${esc(label(d))}<span class="vg-tabn">${d.members.length}</span></label>`).join(""),l=s.length?s.map((d,u)=>`<div class="vg-panel vg-p${u+1}">${pair(r,d,n)}</div>`).join(""):`<div class="vg-single">${renderFragment1(label(r),paneSub(r),splitLines(r.sql),n,paramTips(r))}</div>`;return(i.length>s.length?notice(`\u30B0\u30EB\u30FC\u30D7\u304C\u591A\u3044\u305F\u3081\u5148\u982D ${MAX_TABS} \u4EF6\u306E\u307F\u30BF\u30D6\u8868\u793A\u3057\u3066\u3044\u307E\u3059\uFF08\u5168 ${i.length} \u4EF6\uFF09\u3002`):"")+`<div class="vg-tabs">${p}<div class="vg-tablist">${a}</div><div class="vg-panels">${l}</div></div>`}function renderBase(e,t){const n=t||{},o=e.groups,r=o.length,i=Math.trunc(Number(n.referenceIndex)),s=Number.isFinite(i)&&i>=0&&i<r?i:0,p="vgt"+hashId(e.base+"|"+o.map(label).join("|")+"|"+s);let a;return r===0?a=notice("View \u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002"):a=(r>1?"":notice(e.unmatched?"suffix \u3092\u8A8D\u8B58\u3067\u304D\u306A\u304B\u3063\u305F View \u3067\u3059\u3002\u6BD4\u8F03\u76F8\u624B\u304C\u306A\u3044\u306E\u3067\u5358\u72EC\u3067\u8868\u793A\u3057\u3066\u3044\u307E\u3059\u3002":`${e.viewCount} View \u3059\u3079\u3066\u304C\u540C\u4E00\u30ED\u30B8\u30C3\u30AF\u3067\u3059\u3002\u6BD4\u8F03\u306E\u5FC5\u8981\u304C\u306A\u3044\u306E\u3067 SQL \u3060\u3051\u51FA\u3057\u3066\u3044\u307E\u3059\u3002`))+tabs(o,s,n,p),'<div class="vg-root">'+header(e.base,e.viewCount,r,e.unmatched)+a+missTable(o,s,r>0?label(o[s]):"")+paramsTable(o)+"</div>"}function chromeCss(){const e=[".vg-root{font:13px/1.6 'Roboto','Segoe UI',system-ui,-apple-system,sans-serif;color:#24292F}",".vg-header{display:flex;align-items:center;flex-wrap:wrap;gap:8px;margin:0 0 10px}",".vg-title{font:600 15px/1.6 inherit;color:#1A1A1A}",".vg-badge{display:inline-block;padding:1px 8px;border-radius:10px;font-weight:600;font-size:12px}",".vg-notice{margin:8px 0;padding:8px 12px;border:1px solid #D0D7DE;border-left:4px solid #57606A;border-radius:4px;background:#F6F8FA;color:#57606A}",".vg-r{position:absolute;opacity:0;width:1px;height:1px;pointer-events:none}",".vg-tablist{display:flex;flex-wrap:wrap;gap:4px;border-bottom:1px solid #D0D7DE;margin-bottom:-1px}",".vg-tab{display:inline-flex;align-items:center;gap:6px;padding:6px 14px;border:1px solid transparent;border-bottom:none;border-radius:6px 6px 0 0;color:#57606A;cursor:pointer;user-select:none;font-weight:600}",".vg-tab:hover{background:#EAEEF2;color:#24292F}",".vg-tbase{background:#fbeded;border-color:#efb6b6;color:#24292F;cursor:default}",".vg-tbase:hover{background:#fbeded;color:#24292F}",".vg-tbadge{padding:0 6px;border-radius:8px;background:#f6d7d7;color:#87494a;font-size:11px;font-weight:600}",".vg-tabn{padding:0 6px;border-radius:8px;background:#EAEEF2;color:#57606A;font-size:11px}",".vg-panels{border:1px solid #D0D7DE;border-radius:0 6px 6px 6px;padding:10px;background:#fff}",".vg-panel{display:none}",".vg-params{margin:12px 0 0;border:1px solid #D0D7DE;border-radius:6px;background:#F6F8FA}",".vg-psummary{padding:8px 12px;cursor:pointer;color:#57606A;font-weight:600;font-size:12px}",".vg-pblock{padding:0 12px 10px}",".vg-plabel{font:600 12px/1.8 inherit;color:#24292F}",".vg-pnone{color:#57606A;font-size:12px}",".vg-ptable{border-collapse:collapse;width:100%}",".vg-pname{width:44px;text-align:left;vertical-align:top;padding:3px 8px 3px 0;color:#8250DF;font:600 12px/1.6 ui-monospace,SFMono-Regular,Consolas,monospace}",".vg-pvals{padding:3px 0}",".vg-pv{font:11px/1.6 ui-monospace,SFMono-Regular,Consolas,monospace;color:#57606A;word-break:break-all}",".vg-psuf{display:inline-block;min-width:44px;color:#24292F;font-weight:600}",".vg-mhint{padding:0 12px 8px;color:#57606A;font-size:12px}",".vg-mname{text-align:left;vertical-align:top;padding:3px 10px 3px 0;font:600 12px/1.6 inherit;color:#24292F;white-space:nowrap}",".vg-mvs{vertical-align:top;padding:3px 10px 3px 0;color:#57606A;font-size:12px;white-space:nowrap}",".vg-mreason{padding:3px 0;color:#57606A;font-size:12px}",".vg-mcode{padding:1px 5px;border-radius:3px;background:#FFEBE9;color:#82071E;font:11px/1.6 ui-monospace,SFMono-Regular,Consolas,monospace}",".vg-mkind{margin-left:6px;color:#8250DF;font-size:11px}",".vg-ph{position:relative;margin:0 -2px;padding:0 2px;border-radius:3px;background:#F1E8FD;color:#6639BA;font-weight:700;box-shadow:inset 0 0 0 1px #CDB6F2;cursor:help}",".vg-ph:hover{background:#E4D3FB}",".vg-ph::after{content:attr(data-tip);display:none;position:absolute;z-index:20;left:0;top:calc(100% + 5px);width:max-content;max-width:340px;padding:6px 10px;border-radius:6px;background:#24292F;color:#fff;font:11px/1.7 ui-monospace,SFMono-Regular,Consolas,monospace;white-space:pre-wrap;overflow-wrap:anywhere;text-align:left;box-shadow:0 2px 10px rgba(0,0,0,.30);pointer-events:none}",".vg-ph:hover::after{display:block}",".vg-ph.vg-phr::after{left:auto;right:0}"];for(let t=1;t<=MAX_TABS;t++)e.push(`.vg-r${t}:checked ~ .vg-panels > .vg-p${t}{display:block}`),e.push(`.vg-r${t}:checked ~ .vg-tablist > .vg-t${t}{background:#fff;border-color:#D0D7DE;color:#24292F}`),e.push(`.vg-r${t}:checked ~ .vg-tablist > .vg-t${t} .vg-tabn{background:#DDF4FF;color:#0969DA}`);return e.join(`
...
`+n.markup}return e}function __fixtureRules(e){var t={};function n(c){var d=__split(renderBase(c,e)).rules;for(var u in d)t[u]=d[u]}function o(c,d,u,h){for(var f=[],b=0;b<c.length;b++)f.push({viewName:"v_fixture_"+c[b]});return{suffixes:c,members:f,sql:d,params:u||[],miss:h}}function r(c,d,u){for(var h=0,f=0;f<d.length;f++)h+=d[f].members.length;return{base:c,viewCount:h,groupCount:d.length,unmatched:u,groups:d}}var i=`SELECT
  a,
  b
FROM t_{{P1}}
WHERE x = 1`,s=`SELECT
...
WHERE x = 2`,p=`SELECT
  a
FROM t_{{P1}}
WHERE x = 1`,a=[{name:"{{P1}}",values:{abjp:"t_abjp",abus:"t_abus"}}],l={vs:"abjp, abus",detail:{reason:"not-substitutable",kind:"string",aText:"'apac'",bText:"'amer'"}};return n(r("v_fixture_one",[o(["abjp","abus"],i,[])])),n(r("v_fixture_two",[o(["abjp","abus"],i,a),o(["cdjp"],s,a,l)])),n(r("v_fixture_many",[o(["abjp","abus"],i,a),o(["cdjp"],s,a,l),o(["efjp"],p,a,l)])),n(r("v_fixture_no_suffix",[{suffixes:[null],members:[{viewName:"v_fixture_no_suffix"}],sql:i,params:[]}],!0)),t}return chromeCss()+`
